...
class CAST5
	...
	@keySize : 16
	keySize : CAST5.keySize

	#---------------

	constructor : (key) ->
		@masking = new Array(16)
		@rotate = new Array(16)
		@reset()
		throw new Error "key must be #{n} bytes" unless key.length is (n = @keySize)
		@keySchedule key
	...
	encrypt : (wa_src) ->
		out = @_encrypt_ui8a util.buffer_to_ui8a wa_src.to_buffer()
		WordArray.from_buffer new Buffer out

	#---------------
	
	decrypt : (wa_src) ->
		out = @_decrypt_ui8a util.buffer_to_ui8a wa_src.to_buffer()
		WordArray.from_buffer new Buffer out
	...
	_encrypt_ui8a: (src) ->
		...
		for i in [0...len] by 8
		  ...
		  t = r; r = l^f1(r, @masking[0], @rotate[0]); l = t;
		  t = r; r = l^f2(r, @masking[1], @rotate[1]); l = t;
		  t = r; r = l^f3(r, @masking[2], @rotate[2]); l = t;
		  t = r; r = l^f1(r, @masking[3], @rotate[3]); l = t;

		  t = r; r = l^f2(r, @masking[4], @rotate[4]); l = t;
		  t = r; r = l^f3(r, @masking[5], @rotate[5]); l = t;
		  t = r; r = l^f1(r, @masking[6], @rotate[6]); l = t;
		  t = r; r = l^f2(r, @masking[7], @rotate[7]); l = t;

		  t = r; r = l^f3(r, @masking[8] , @rotate[8]); l = t;
		  t = r; r = l^f1(r, @masking[9] , @rotate[9]); l = t;
		  t = r; r = l^f2(r, @masking[10], @rotate[10]); l = t;
		  t = r; r = l^f3(r, @masking[11], @rotate[11]); l = t;

		  t = r; r = l^f1(r, @masking[12], @rotate[12]); l = t;
		  t = r; r = l^f2(r, @masking[13], @rotate[13]); l = t;
		  t = r; r = l^f3(r, @masking[14], @rotate[14]); l = t;
		  t = r; r = l^f1(r, @masking[15], @rotate[15]); l = t;
	...
	f1 : (d, m, r) ->
		t = m + d
		I = (t << r) | (t >>> (32 - r))
		((G.sBox[0][I>>>24] ^ G.sBox[1][(I>>>16)&255]) - G.sBox[2][(I>>>8)&255]) + G.sBox[3][I&255]
