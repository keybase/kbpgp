...
(function() {
  ...
  KeyWrapper = (function() {
    ...
    KeyWrapper.prototype.overwrite_with = function(kw2) {
      console.log("XXXX");
      console.log(kw2.lifespan);
      console.log(this.lifespan);
      if (!kw2.lifespan.expires_earlier_than(this.lifespan)) {
        console.log("update");
        this.key = kw2.key, this.lifespan = kw2.lifespan, this._pgp = kw2._pgp, this._keybase = kw2._keybase, this.flags = kw2.flags;
      }
      console.log("new lifespan ---->");
      return console.log(this.lifespan);
    };
