  ...
  exports.BaseBurner = BaseBurner = (function() {
    ...
    BaseBurner.prototype._make_session_key = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          ...
          _this._session_key = new Buffer((function() {
            var _i, _ref3, _results;
            _results = [];
            for (i = _i = 0, _ref3 = this._cipher_info.key_size; 0 <= _ref3 ? _i < _ref3 : _i > _ref3; i = 0 <= _ref3 ? ++_i : --_i) {
              _results.push(i);
            }
            return _results;
          }).call(_this));
    ...
    BaseBurner.prototype._generate_iv = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          console.log("DEBUG HORRIBLE SECURITY");
          _this.prefixrandom = new Buffer((function() {
            var _i, _ref3, _results;
            _results = [];
            for (i = _i = 0, _ref3 = this.cipher.blockSize; 0 <= _ref3 ? _i < _ref3 : _i > _ref3; i = 0 <= _ref3 ? ++_i : --_i) {
              _results.push(i + 128);
            }
            return _results;
          }).call(_this));
