...
(function() {
  var C, ClearSigner, CreationTime, Issuer, SHA512, SRF, Signature, Verifier, WordArray, bufferify, clearsign_header, clearsign_to_sign, dash_escape, dash_unescape_line, dash_unescape_lines, encode, export_key_pgp, get_cipher, hashmod, iced, input_to_cleartext, input_to_cleartext_display, input_to_cleartext_sign, konst, make_esc, scrub_buffer, trailing_whitespace_strip, triplesec, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  exports.input_to_cleartext_sign = input_to_cleartext_sign = function(lines) {
    ...
    if (tmp.length && tmp.slice(-1)[0] === '') {
      tmp.pop();
    }
    return tmp.join("\r\n");
  };

  exports.whitespace_strip = trailing_whitespace_strip = function(line) {
    var m;
  ...
  ClearSigner = (function() {
    ...
    ClearSigner.prototype._encode = function(cb) {
      var body, hdr;
      hdr = clearsign_header(C, this._clearsign.show, this.hasher_name());
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              _this._enocde(esc(__iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
  ...
  Verifier = (function() {
    ...
    Verifier.prototype._find_signature = function(cb) {
      var err, n;
      err = (n = this.packets.length) !== 1 ? new Error("Expected one signature packet; got " + n) : (this._sig = packets[0]).tag !== C.packet_tags.signature ? new Error("Expected a signature packet; but got type=" + packets[0].tag) : null;
      return cb(null);
    };
      ...
      (function(_this) {
        ...
        return function() {
          if (typeof err === "undefined" || err === null) {
            ...
            _this._sig.hasher = hashmod[_this.clearsign.headers.has];
          }
          return cb(err);
        };
      })(this));
  ...
  exports.verify = function(_arg) {
    var clearsign, err, key_fetch, literal, pakcets, v, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    pakcets = _arg.pakcets, clearsign = _arg.clearsign, key_fetch = _arg.key_fetch;
    v = new Verifier({
      packets: packets,
      clearsign: clearsign,
      key_fetch: key_fetch
