...
(function() {
  var C, Compressed, Demux, Generic, KeyMaterial, Literal, MessageParser, OnePassSignature, PKESK, PacketParser, SEIPD, Signature, SlicerBuffer, SmallDepacketizer, StreamingDepacketizer, UserAttribute, UserID, iced, inspect, make_esc, parse, util, xbt, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  _ref1 = require('./packet/xbt_depacketizer'), StreamingDepacketizer = _ref1.StreamingDepacketizer, SmallDepacketizer = _ref1.SmallDepacketizer;
  ...
  exports.Demux = Demux = (function(_super) {
    ...
    Demux.prototype.run = function(cb) {
      ...
      console.log("" + this._obj_id + " peeeking...");
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase/kbpgp/src/openpgp/parser.iced",
            funcname: "Demux.run"
          });
        ...
        return function() {
          console.log("" + _this._obj_id + " peeked " + (typeof b !== "undefined" && b !== null ? b.toString('hex') : void 0));
          (function(__iced_k) {
            if (typeof b !== "undefined" && b !== null ? b.length : void 0) {
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  parent: ___iced_passed_deferral,
                  filename: "/Users/max/src/keybase/kbpgp/src/openpgp/parser.iced",
    ...
    Demux.prototype._demux = function(c, cb) {
      var PT, err, klass, out, packet_version, packet_xbt, tag;
      ...
      } else if (klass.new_xbt_parser != null) {
        packet_xbt = klass.new_xbt_parser({
          demux_klass: Demux
        });
        out = new StreamingDepacketizer({
          packet_version: packet_version,
          demux_klass: Demux,
          packet_xbt: packet_xbt
        });
      } else {
        out = new SmallDepacketizer({
          packet_version: packet_version,
          demux_klass: Demux,
          packet_klass: klass
        });
