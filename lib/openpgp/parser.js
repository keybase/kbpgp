...
(function() {
  var C, Compressed, Demux, DemuxSequence, Depacketizer, Generic, KeyMaterial, Literal, MessageParser, OnePassSignature, PKESK, PacketParser, SEIPD, Signature, SlicerBuffer, UserAttribute, UserID, iced, inspect, make_esc, parse, util, xbt, __iced_k, __iced_k_noop, _ref,
  ...
  exports.DemuxSequence = DemuxSequence = (function(_super) {
    ...
    DemuxSequence.prototype.xbt_type = function() {
