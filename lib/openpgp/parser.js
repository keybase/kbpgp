...
(function() {
  var C, Compressed, Demux, Depacketizer, Generic, KeyMaterial, Literal, MessageParser, OnePassSignature, PKESK, PacketParser, SEIPD, Signature, SlicerBuffer, UserAttribute, UserID, inspect, parse, util, xbt, _ref,
  ...
  exports.Demux = Demux = (function(_super) {
    ...
    Demux.prototype.peek_bytes = function() {
      return 1;
    };

    Demux.prototype._demux = function(_arg, cb) {
      var PT, c, data, eof, err, klass, packet_version, packet_xbt, tag;
      data = _arg.data, eof = _arg.eof;
      err = xbt = packet_version = null;
      if (data == null) {

      } else if (((c = data.readUInt8(0)) & 0x80) === 0) {
