...
(function() {
  var Burner, CreationTime, Issuer, OnePassSignature, SRF, Signature, export_key_pgp, get_cipher, iced, make_esc, scrub_buffer, triplesec, unix_time, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  exports.burn = function(_arg, cb) {
    var b, encryption_key, err, msg, out, signing_key, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    msg = _arg.msg, signing_key = _arg.signing_key, encryption_key = _arg.encryption_key;
    b = new Burner({
      msg: msg,
