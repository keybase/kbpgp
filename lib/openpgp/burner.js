...
(function() {
  var Burner, C, Compressed, CreationTime, Issuer, OnePassSignature, SHA512, SRF, Signature, export_key_pgp, get_cipher, iced, make_esc, scrub_buffer, triplesec, unix_time, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  Burner = (function() {
    ...
    Burner.prototype._sign = function(cb) {
      var err, esc, flat_packets, fp, ops, ops_framed, sig, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(__iced_k) {
        ...
        flat_packets = Buffer.concat(_this.packets);
        (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "src/openpgp/burner.iced",
          ...
          sig.write(flat_packets, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
