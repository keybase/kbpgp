...
(function() {
  var Burner, C, Compressed, CreationTime, Issuer, Literal, OnePassSignature, PKESK, SEIPD, SHA512, SRF, Signature, WordArray, clearsign, dummy_key_id, encode, export_key_pgp, get_cipher, iced, make_esc, make_simple_literals, scrub_buffer, triplesec, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  Burner = (function() {
    function Burner(_arg) {
      this.literals = _arg.literals, this.signing_key = _arg.signing_key, this.encryption_key = _arg.encryption_key, this.opts = _arg.opts;
      this.packets = [];
      this.opts || (this.opts = {});
    ...
    Burner.prototype._encrypt_session_key = function(cb) {
      var ekey, err, key_id, max, payload, pkt, pub_k, slosh, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          pub_k.pad_and_encrypt(payload, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                err = arguments[0];
        ...
        return function() {
          (function(__iced_k) {
            if (typeof err === "undefined" || err === null) {
              (function(__iced_k) {
                if (_this.opts.hide != null) {
                  key_id = dummy_key_id;
                  max = _this.opts.hide_max || 8192;
                  slosh = _this.opts.hide_slosh || 128;
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                      filename: "/Users/max/src/keybase/kbpgp/src/openpgp/burner.iced",
  ...
  exports.burn = function(_arg, cb) {
    var aout, b, encryption_key, err, literals, msg, opts, raw, signing_key, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    msg = _arg.msg, literals = _arg.literals, signing_key = _arg.signing_key, encryption_key = _arg.encryption_key, opts = _arg.opts;
