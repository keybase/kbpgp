...
(function() {
  ...
  Burner = (function() {
    ...
    Burner.prototype._encrypt_session_key = function(cb) {
      var ekey, esc, key_id, payload, pkt, pub_k, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          pub_k.pad_and_encrypt(payload, esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
          ...
          (function(__iced_k) {
            if (_this.opts.hide != null) {
              ...
              (function(__iced_k) {
                ...
                ekey.hide({
                  max: _this.opts.hide_max,
                  slosh: _this.opts.hide_slosh,
                  key: pub_k
