...
(function() {
  ...
  Burner = (function(_super) {
    ...
    Burner.prototype._sign = function(cb) {
      var esc, fp, ops_framed, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this._make_ops_packet().write(esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            _this._make_sig_packet({}).write(_this.signed_payload, esc(__iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
    ...
    Burner.prototype._encrypt_payload = function(cb) {
      var esc, pkt, plaintext, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
