...
(function() {
  var Burner, C, Compressed, CreationTime, Issuer, Literal, OnePassSignature, PKESK, SEIPD, SHA512, SRF, Signature, WordArray, encode, export_key_pgp, get_cipher, iced, make_esc, make_simple_literals, scrub_buffer, triplesec, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2;
  ...
  Burner = (function() {
    ...
    Burner.prototype._encrypt_session_key = function(cb) {
      var ekey, err, k, payload, pkt, y_buf, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
  ...
  exports.burn = function(_arg, cb) {
    var armor, b, encryption_key, err, literals, msg, out, signing_key, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    msg = _arg.msg, literals = _arg.literals, signing_key = _arg.signing_key, encryption_key = _arg.encryption_key, armor = _arg.armor;
    ...
    (function(__iced_k) {
      ...
      b.scrub();
      if ((typeof out !== "undefined" && out !== null) && (typeof err === "undefined" || err === null) && armor) {
        out = encode(C.message_types.generic, out);
      }
      return cb(err, out);
    });
  };
