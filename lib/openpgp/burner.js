...
(function() {
  var Burner, C, Compressed, CreationTime, Issuer, OnePassSignature, SHA512, SRF, Signature, WordArray, export_key_pgp, get_cipher, iced, make_esc, scrub_buffer, triplesec, unix_time, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  Burner = (function() {
    ...
    Burner.prototype._encrypt_session_key = function(cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      payload = export_key_pgp(this._cipher_algo, this._session_key.to_buffer());
