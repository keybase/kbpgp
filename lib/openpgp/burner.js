...
(function() {
  ...
  Burner = (function(_super) {
            ...
            if (!(_i < _len)) {
              ...
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  ...
                  filename: "/home/michal.linux/KB/kbpgp/src/openpgp/burner.iced",
    ...
    Burner.prototype._compress = function(cb) {
      var algo, esc, inflated, opkt, pkt, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      esc = make_esc(cb, "Burner::_compress");
      inflated = this.collect_packets();
      algo = (_ref3 = this.opts.compression) != null ? _ref3 : C.compression.zlib;
      pkt = new Compressed({
        algo: algo,
        inflated: inflated
      });
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                if ((_this.opts.compression == null) || _this.opts.compression !== C.compression.none) {
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                      filename: "/home/michal.linux/KB/kbpgp/src/openpgp/burner.iced",
