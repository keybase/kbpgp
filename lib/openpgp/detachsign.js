...
(function() {
  var C, Ch, CreationTime, Issuer, Literal, Signature, Signer, Verifier, VerifierBase, WordArray, encode, hash_obj_to_fn, iced, konst, make_esc, streamers, unix_time, __iced_k, __iced_k_noop, _ref,
  ...
  Verifier = (function(_super) {
    ...
    Verifier.prototype._consume_data = function(cb) {
      ...
      streamer = streamers[this._sig.hasher.algname]();
