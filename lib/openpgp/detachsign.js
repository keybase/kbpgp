...
(function() {
  var C, Ch, CreationTime, Issuer, Literal, SHA512, Signature, Signer, Verifier, VerifierBase, WordArray, encode, hash_obj_to_fn, iced, konst, make_esc, triplesec, unix_time, __iced_k, __iced_k_noop, _ref,
  ...
  Verifier = (function(_super) {
    ...
    Verifier.prototype._consume_data = function(cb) {
      var buf_hasher, done, err, go, hasher, klass, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      ...
      buf_hasher = function(buf) {
        return hasher.update(WordArray.from_buffer(buf));
      };
      (function(_this) {
        return (function(__iced_k) {
          if (_this.data) {
            return __iced_k(buf_hasher(_this.data));
          } else {
            go = true;
            (function(__iced_k) {
              var _results, _while;
    ...
    Verifier.prototype._verify = function(cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this._sig.verify([], __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
  ...
  exports.verify = function(_arg, cb) {
    var data, data_fn, err, keyfetch, packets, v, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
