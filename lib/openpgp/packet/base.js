...
(function() {
  ...
  Packet = (function() {
    ...
    Packet.prototype.stream = function(_arg, cb) {
      var body, buf, err, stream, tag, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      stream = _arg.stream, tag = _arg.tag, body = _arg.body;
      err = null;
      (function(_this) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            if (err == null) {
              buf = Buffet.concat([_this.tagbuf(tag), body]);
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  parent: ___iced_passed_deferral,
                  filename: "/Users/max/src/keybase/kbpgp/src/openpgp/packet/base.iced",
                ...
                stream.write(buf, __iced_deferrals.defer({
                  lineno: 24
                }));
                __iced_deferrals._fulfill();
              })(__iced_k);
