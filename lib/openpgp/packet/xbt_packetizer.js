...
(function() {
  ...
  exports.Packetizer = Packetizer = (function(_super) {
    ...
    function Packetizer(_arg) {
      var header, log2_chunksz, packet;
      log2_chunksz = _arg.log2_chunksz, packet = _arg.packet, header = _arg.header;
    ...
    Packetizer.prototype.packet = function() {
      return this._packet;
    };
          ...
          if (_this._packet != null) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/home/max/src/keybase/kbpgp/src/openpgp/packet/xbt_packetizer.iced",
