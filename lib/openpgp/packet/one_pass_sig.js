...
(function() {
  var C, OPS_Parser, OnePassSignature, Packet, PacketParser, XbtOut, asymmetric, hash, iced, make_esc, uint_to_buffer, xbt, __iced_k, __iced_k_noop,
  ...
  OnePassSignature = (function(_super) {
    ...
    OnePassSignature.parse = function(slice, _arg) {
      var streaming;
      streaming = _arg.streaming;
      return (new OPS_Parser(slice, {
        streaming: streaming
      })).parse();
    };
    ...
    OnePassSignature.prototype.finish_xbt_packet = function(_arg, cb) {
      var err, xbt, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            funcname: "OnePassSignature.finish_xbt_packet"
          });
          xbt.set_root_metadata({
            slice: 'ops',
            value: _this
        ...
        return function() {
          xbt.get_root().push_hasher(_this.hasher);
          return cb(err);
        };
      })(this));
    };
  ...
  OPS_Parser = (function() {
    function OPS_Parser(slice, _arg) {
      this.slice = slice;
      this.streaming = _arg.streaming;
    }
    ...
    OPS_Parser.prototype.parse = function() {
      ...
      hasher = hash.alloc_or_throw(hasher, this.streaming);
