...
(function() {
  ...
  OPS_Parser = (function() {
    ...
    OPS_Parser.prototype._alloc = function(_arg) {
      var hasher, is_final, key_id, sig_klass, sig_type, version;
      version = _arg.version, sig_type = _arg.sig_type, hasher = _arg.hasher, sig_klass = _arg.sig_klass, key_id = _arg.key_id, is_final = _arg.is_final;
    ...
    OPS_Parser.prototype.alloc = function(args, cb) {
      var e, err, ret;
      ret = err = null;
      try {
  ...
  exports.XbtIn = XbtIn = (function(_super) {
    ...
    XbtIn.prototype._parse_header = function(cb) {
      var err, esc, hasher, is_final, key_id, packet, sig_klass, sig_type, version, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
