...
(function() {
  var C, Literal, LiteralParser, OutStream, Packet, PacketParser, Packetizer, XbtIn, XbtOut, asymmetric, iced, make_esc, uint_to_buffer, __iced_k, __iced_k_noop, _ref,
  ...
  XbtIn = (function(_super) {
    ...
    function XbtIn() {
      XbtIn.__super__.constructor.apply(this, arguments);
    }

    XbtIn.prototype._parse_header = function() {
      var date, err, esc, filename, format, rmd, ___iced_passed_deferral, __iced_deferrals, __iced_k;
        ...
        return function() {
          (function(__iced_k) {
            ...
            (function(__iced_k) {
              ...
              if ((rmd = _this.get_root_metadata()) != null) {
