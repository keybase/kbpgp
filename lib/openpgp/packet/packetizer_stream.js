...
(function() {
  var Transform, iced, stream, test, util, __iced_k, __iced_k_noop,
  ...
  exports.PacketizerStream = Transform = (function(_super) {
    ...
    function Transform(_arg) {
      var header, log2_chunksz, tag;
      tag = _arg.tag, log2_chunksz = _arg.log2_chunksz, header = _arg.header;
    ...
    Transform.prototype._transform = function(buf, encoding, cb) {
