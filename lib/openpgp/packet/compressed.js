...
(function() {
  var C, Compressed, CompressionParser, Packet, asymmetric, bzipDeflate, bzip_inflate, fake_zip_deflate, fake_zip_inflate, iced, uint_to_buffer, zlib, __iced_k, __iced_k_noop,
    ...
    (function(_this) {
      return (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          ...
          filename: "/home/michal.linux/KB/kbpgp/src/openpgp/packet/compressed.iced"
        });
  ...
  fake_zip_deflate = function(buf, cb) {
    ...
    (function(_this) {
      return (function(__iced_k) {
        ...
        zlib.deflateRaw(buf, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              err = arguments[0];
