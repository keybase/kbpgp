...
(function() {
  var C, Compressed, CompressionParser, Packet, PacketParser, Packetizer, ReverseAdapter, XbtIn, XbtOut, asymmetric, bzip_inflate, compressjs, fake_zip_deflate, fake_zip_inflate, iced, make_esc, uint_to_buffer, zlib, __iced_k, __iced_k_noop,
  ...
  XbtIn = (function(_super) {
        ...
        return function() {
          _this.inflater = (function() {
            switch (algo) {
              ...
              default:
                return err = new Error("unhanalded streaming inflation algorithn: " + algo);
            }
          })();
          return cb(err);
        };
    ...
    XbtIn.prototype._flow = function(_arg, cb) {
      var data, eof, esc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      data = _arg.data, eof = _arg.eof;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/home/max/src/keybase/kbpgp/src/openpgp/packet/compressed.iced",
            funcname: "XbtIn._flow"
          });
          _this.inflater.chunk({
            data: data,
            eof: eof
          }, esc(__iced_deferrals.defer({
            assign_fn: (function() {
