...
(function() {
  ...
  Signature = (function(_super) {
    ...
    Signature.prototype._verify = function(data_packets, cb, opts) {
      var SKB, T, buffers, d, data, dp, err, expires, hvalue, n, packets, payload, ps, sig, subkey, user_attribute, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      T = C.sig_types;
      ...
      console.log("A " + (err != null ? err.toString() : void 0));
      (function(_this) {
        return (function(__iced_k) {
          var _ref3;
          if (err == null) {
        ...
        return function() {
          ...
          console.log("B " + (err != null ? err.toString() : void 0));
          if (err == null) {
            _ref3 = _this._check_key_sig_expiration(opts), err = _ref3[0], expires = _ref3[1];
          }
          console.log("C " + (err != null ? err.toString() : void 0));
          if (err == null) {
            err = _this._check_subkey_wasnt_expired(opts);
          }
          console.log("D " + (err != null ? err.toString() : void 0));
          sig = _this;
          if (err == null) {
          ...
          console.log("E " + (err != null ? err.toString() : void 0));
          return cb(err);
        };
      })(this));
    };
    ...
    Signature.prototype._check_subkey_wasnt_expired = function(opts) {
      var e, err, km, n, now, _ref3, _ref4;
      if ((e = (_ref3 = (km = this.key_material)) != null ? (_ref4 = _ref3.get_expire_time()) != null ? _ref4.expire_at : void 0 : void 0)) {
    ...
    Signature.prototype._check_key_sig_expiration = function(opts) {
      var T, creation, err, expiration, key_expiration, n, now, _ref3;
      err = null;
      T = C.sig_types;
      key_expiration = 0;
      if ((_ref3 = this.type) === T.issuer || _ref3 === T.personal || _ref3 === T.casual || _ref3 === T.positive || _ref3 === T.subkey_binding || _ref3 === T.primary_binding) {
        ...
        if ((creation != null) && (expiration != null)) {
          ...
          if ((now > expiration) && expiration !== 0 && !opts.time_travel) {
