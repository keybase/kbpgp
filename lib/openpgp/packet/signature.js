...
(function() {
  ...
  Signature = (function(_super) {
    ...
    Signature.prototype.finish_xbt_packet = function(_arg, cb) {
      var esc, xbt, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      xbt = _arg.xbt;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase/kbpgp/src/openpgp/packet/signature.iced",
            funcname: "Signature.finish_xbt_packet"
          });
        ...
        return function() {
          (function(__iced_k) {
            ...
            xbt.get_root().verify_sig(esc(__iced_deferrals.defer({
              lineno: 340
            })));
            __iced_deferrals._fulfill();
          })(function() {
