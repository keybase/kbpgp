...
(function() {
  ...
  SubPacket = (function() {
    ...
    SubPacket.prototype.to_buffer = function() {
      ...
      return Buffer.concat([encode_length(inner.length + 1), uint_to_buffer(8, this.type | (this.critical ? 0x80 : 0x00)), inner]);
    };
  ...
  Parser = (function() {
    ...
    Parser.prototype.parse_subpacket = function() {
      var critical, end, klass, len, raw_type, ret, type;
