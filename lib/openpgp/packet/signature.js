...
(function() {
  ...
  Signature_v3 = (function(_super) {
    ...
    Signature_v3.prototype.is_signature = function() {
      return true;
    };
    ...
    Signature_v3.prototype.get_issuer_key_id = function() {
      return this.key_id;
    };

    Signature_v3.prototype.when_generated = function() {
      return this.time;
    };

    Signature_v3.prototype.time_of_primary_uid_sig = function() {
      return null;
    };
  ...
  Signature = (function(_super) {
    ...
    Signature.prototype.get_key_id = function() {
      ...
      if (this.key_id) {
        ...
        return ((_ref3 = this.subpacket_index.hashed[S.issuer]) != null ? _ref3.id : void 0) || ((_ref4 = this.subpacket_index.unhashed[S.issuer]) != null ? _ref4.id : void 0);
      }
    };
    ...
    Signature.prototype._verify = function(data_packets, cb) {
      var SKB, T, buffers, d, data, dp, err, n, packets, payload, ps, sig, subkey, user_attribute, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      T = C.sig_types;
    ...
    Signature.prototype.get_issuer_key_id = function() {
      var _ref3, _ref4;
      return (_ref3 = this.subpacket_index) != null ? (_ref4 = _ref3.unhashed[C.sig_subpacket.issuer]) != null ? _ref4.id : void 0 : void 0;
    };
