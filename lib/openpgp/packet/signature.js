...
(function() {
  ...
  Signature = (function(_super) {
    ...
    Signature.prototype._verify = function(data_packets, cb) {
      var SKB, T, buffers, d, data, dp, err, hvalue, i, lines, n, packets, parts, payload, ps, sig, subkey, user_attribute, userid, x, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      T = C.sig_types;
        ...
        return (function(__iced_k) {
          ...
          if (err == null) {
            ...
            parts = (function() {
              ...
              _results = [];
              for (i = _i = 0, _ref4 = x.length; _i < _ref4; i = _i += 4) {
                _results.push(x.slice(i, i + 4));
              }
              return _results;
            })();
            lines = (function() {
              var _i, _ref4, _results;
              _results = [];
              for (i = _i = 0, _ref4 = parts.length; _i < _ref4; i = _i += 8) {
                _results.push(parts.slice(i, i + 8).join(' '));
              }
              return _results;
            })();
