...
(function() {
  ...
  Signature = (function(_super) {
    ...
    Signature.prototype._verify = function(data_packets, cb) {
      var SKB, T, buffers, d, data, dp, err, options, packets, payload, sig, subkey, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
          ...
          switch (_this.type) {
            ...
            case T.positive:
              ...
              if ((userid = _this.data_packets[1].to_userid()) != null) {
                _this.primary.push_sig(new packetsigs.SelfSig({
                  type: _this.type,
                  options: options,
                  userid: userid,
                  sig: sig
