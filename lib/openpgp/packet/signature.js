...
(function() {
  ...
  Signature = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/max/src/keybase/submodules/kbpgp/src/openpgp/packet/signature.iced",
    ...
    Signature.prototype._verify = function(data_packets, cb) {
      var SKB, T, buffers, d, data, dp, err, n, packets, payload, ps, sig, subkey, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      T = C.sig_types;
  ...
  PrimaryUserId = (function(_super) {
    ...
    function PrimaryUserId(flag) {
      this.flag = flag;
      console.log("parsing PrimaryUserId");
    ...
    PrimaryUserId.prototype._v_to_buffer = function() {
      console.log("_v_to_buffer");
      console.log(this.flag);
      return uint_to_buffer(8, this.flag ? 1 : 0);
    };
