...
(function() {
  ...
  Signature = (function(_super) {
    ...
    Signature.prototype.write_unframed = function(data, cb) {
      var hvalue, payload, prefix, result2, results, s, sig, uhsp, _ref3;
    ...
    Signature.prototype._verify = function(data_packets, cb) {
      var T, buffers, data, dp, err, options, packets, payload, primary, sig, subkey, userid, _ref3;
      err = null;
      T = C.sig_types;
      primary = subkey = null;
      ...
      if (err == null) {
        err = this._check_key_sig_expiration();
      }
      sig = this;
      if (err == null) {
        switch (this.type) {
          ...
          case T.casual:
          case T.positive:
            options = this._export_hashed_subpackets();
