...
(function() {
          ...
          if (v !== (b = _this.signed_hash_value_hash)) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/michal/SourceCode/keybase/go/src/github.com/keybase/kbpgp/src/openpgp/packet/signature.iced",
  ...
  Unknown = (function(_super) {
    ...
    function Unknown(buf, type) {
      this.buf = buf;
      this.type = type;
    }

    Unknown.parse = function(slice, type) {
      return new Unknown(slice.consume_rest_to_buffer(), type);
    };

    Unknown.prototype._v_to_buffer = function() {
      return this.buf;
    };
  ...
  PreferredAEADAlgorithms = (function(_super) {
    __extends(PreferredAEADAlgorithms, _super);

    function PreferredAEADAlgorithms(v) {
      PreferredAEADAlgorithms.__super__.constructor.call(this, S.preferred_aead_algos, v);
    }

    PreferredAEADAlgorithms.parse = function(slice) {
      return Preference.parse(slice, PreferredAEADAlgorithms);
    };
