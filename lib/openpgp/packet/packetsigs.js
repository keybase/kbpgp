...
(function() {
  ...
  Base = (function() {
    function Base(_arg) {
      this.sig = _arg.sig, this.expires = _arg.expires;
    }
  ...
  SelfSig = (function(_super) {
    ...
    function SelfSig(_arg) {
      var expires, sig;
      this.userid = _arg.userid, this.user_attribute = _arg.user_attribute, this.type = _arg.type, sig = _arg.sig, this.options = _arg.options, expires = _arg.expires;
  ...
  SubkeyBinding = (function(_super) {
    ...
    function SubkeyBinding(_arg) {
      var expires, sig;
      this.primary = _arg.primary, sig = _arg.sig, this.direction = _arg.direction, expires = _arg.expires;
  ...
  Data = (function(_super) {
    ...
    function Data(_arg) {
      var expires, sig;
      this.key = _arg.key, sig = _arg.sig, expires = _arg.expires;
