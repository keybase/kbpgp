...
(function() {
  ...
  exports.Depacketizer = Depacketizer = (function(_super) {
    ...
    Depacketizer.prototype.xbt_type = function() {
      return "Depacketizer";
    };

    Depacketizer.prototype.run = function(cb) {
      var data, demux, esc, final, len, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      final = false;
          ...
          (function(__iced_k) {
            if (!_this._is_eof() || _this._inq.n_bytes()) {
              ...
              (function(__iced_k) {
                ...
                _this._stream_to(demux, esc(__iced_deferrals.defer({
                  lineno: 68
                })));
                __iced_deferrals._fulfill();
              })(__iced_k);
