...
(function() {
  var C, Depacketizer, PacketParser, PgpReadBufferer, bufcat, iced, xbt, __iced_k, __iced_k_noop,
    ...
    Depacketizer.prototype._find_length = function(cb) {
      ...
      (function(_this) {
        ...
        return function() {
          ...
          final = true;
          (function(__iced_k) {
            if (_this.packet_version === C.packet_versions.old) {
              nxt = (function() {
                switch (tag & 0x03) {
                  case 0:
  ...
  exports.PacketParser = PacketParser = (function(_super) {
    ...
    function PacketParser() {
      return PacketParser.__super__.constructor.apply(this, arguments);
    }
