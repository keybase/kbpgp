...
(function() {
  ...
  KeyMaterial = (function(_super) {
    ...
    KeyMaterial.prototype._self_sign_key = function(_arg, cb) {
      var err, lifespan, payload, sig, sigpkt, type, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(__iced_k) {
        ...
        userids.sig = sig;
        _this.push_sig(new packetsigs.SelfSig({
          userid: userid,
          type: type,
          sig: sig,
          options: _this.flags
