...
(function() {
  ...
  KeyMaterial = (function(_super) {
    ...
    KeyMaterial.prototype.get_expire_time = function() {
      var expire_at, expire_in, generated, i, list, packetsig, psc, sig, winner, _i, _len;
      if ((psc = this.get_psc()) == null) {
        return null;
      }
      list = psc.lookup[this.is_primary() ? "self_sig" : "subkey_binding"];
      ...
      for (i = _i = 0, _len = list.length; _i < _len; i = ++_i) {
        packetsig = list[i];
        if (!((packetsig.sig != null) && (this.is_primary() || packetsig.is_down()))) {
          continue;
        }
        sig = packetsig.sig;
        ...
        } else if (((expire_in != null) && expire_in === 0) || ((expire_in == null) && !this.is_primary())) {
          winner = {
            generated: generated,
            expire_in: null,
            expire_at: null
