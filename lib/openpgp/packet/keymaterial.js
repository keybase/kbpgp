...
(function() {
  var AES, C, DSA, KeyMaterial, Packet, Parser, RSA, S, S2K, SHA1, SHA256, Signature, bufeq_secure, bufferify, calc_checksum, decrypt, encode, encrypt, iced, katch, make_time_packet, native_rng, packetsigs, symmetric, triplesec, uint_to_buffer, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  KeyMaterial = (function(_super) {
    ...
    KeyMaterial.prototype.self_sign_key = function(_arg, cb) {
      var err, lifespan, userid, userids, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      userids = _arg.userids, lifespan = _arg.lifespan;
      err = null;
      (function(_this) {
                  ...
                  if (_this.key.can_sign()) {
                    (function(__iced_k) {
                      __iced_deferrals = new iced.Deferrals(__iced_k, {
                        ...
                        filename: "/home/max/src/kbpgp/src/openpgp/packet/keymaterial.iced",
                    ...
                    return __iced_k((userid.get_framed_signature_output()) == null ? err = new Error("Cannot sign key --- don't have a private key, and can't replay") : void 0);
                  }
                })(_next);
              } else {
                return _continue();
    ...
    KeyMaterial.prototype._self_sign_key = function(_arg, cb) {
      var err, lifespan, payload, ps, sig, type, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      userid = _arg.userid, lifespan = _arg.lifespan;
      payload = Buffer.concat([this.to_signature_payload(), userid.to_signature_payload()]);
      type = C.sig_types.issuer;
      sig = new Signature({
        type: type,
        key: this.key,
        hashed_subpackets: [new S.CreationTime(lifespan.generated), new S.KeyFlags([this.flags]), new S.KeyExpirationTime(lifespan.expire_in), new S.PreferredSymmetricAlgorithms([C.symmetric_key_algorithms.AES256, C.symmetric_key_algorithms.AES128]), new S.PreferredHashAlgorithms([C.hash_algorithms.SHA512, C.hash_algorithms.SHA256]), new S.Features([C.features.modification_detection]), new S.KeyServerPreferences([C.key_server_preferences.no_modify])],
    ...
    KeyMaterial.prototype._sign_subkey_with_primary = function(_arg, cb) {
      var err, lifespan, payload, primary_binding, sig, subkey, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    KeyMaterial.prototype.fulfills_flags = function(flags) {
      return (this.get_all_key_flags() & flags) === flags;
    };
    ...
    Parser.prototype.parse_public_key_mpis = function() {
      ...
      _ref3 = (function() {
        switch (this.algorithm) {
          ...
          case A.DSA:
            return DSA.parse(this.slice.peek_rest_to_buffer());
          default:
