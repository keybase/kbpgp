...
(function() {
  var AES, C, KeyMaterial, Packet, Parser, RSA, S, S2K, SHA1, SHA256, Signature, UserID, bufeq_secure, bufferify, calc_checksum, decrypt, encode, encrypt, iced, katch, make_time_packet, native_rng, symmetric, triplesec, uint_to_buffer, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  KeyMaterial = (function(_super) {
    ...
    KeyMaterial.prototype.sign_primary = function(_arg, cb) {
      ...
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/openpgp/packet/keymaterial.iced",
          funcname: "KeyMaterial.sign_primary"
        });
