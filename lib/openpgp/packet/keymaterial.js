...
(function() {
  ...
  KeyMaterial = (function(_super) {
    ...
    function KeyMaterial(_arg) {
      var F, primary;
      this.key = _arg.key, this.timestamp = _arg.timestamp, this.userid = _arg.userid, this.passphrase = _arg.passphrase, this.skm = _arg.skm, primary = _arg.primary;
      this.primary_flag = primary;
      if (this.userid != null) {
    ...
    KeyMaterial.parse_public_key = function(slice, primary) {
      return (new Parser(slice)).parse_public_key(primary);
    };

    KeyMaterial.parse_private_key = function(slice, primary) {
      return (new Parser(slice)).parse_private_key(primary);
    };
    ...
    KeyMaterial.prototype.is_signed_subkey_of = function(primary) {
      return (!this.primary_flag) && (this.signed != null) && this.signed.subkey_of_primary && this.signed.primary_of_subkey && this.signed.primary.equal(primary);
    };
  ...
  Parser = (function() {
    ...
    Parser.prototype.parse_public_key = function(primary) {
      var key;
    ...
    Parser.prototype.parse_private_key = function(primary) {
