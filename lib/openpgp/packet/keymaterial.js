...
(function() {
  var AES, C, DSA, ElGamal, KeyMaterial, Packet, Parser, RSA, S, S2K, SHA1, SHA256, Signature, bufeq_secure, bufferify, calc_checksum, decrypt, encode, encrypt, iced, katch, make_time_packet, native_rng, packetsigs, symmetric, triplesec, uint_to_buffer, unix_time, util, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  KeyMaterial = (function(_super) {
    ...
    KeyMaterial.prototype.self_sign_key = function(_arg, cb) {
      var err, lifespan, raw_payload, sig, sigs, userid, userids, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    KeyMaterial.prototype._self_sign_key = function(_arg, cb) {
      var err, lifespan, payload, ps, raw_payload, sig, type, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      userid = _arg.userid, lifespan = _arg.lifespan, raw_payload = _arg.raw_payload;
