...
(function() {
  ...
  KeyMaterial = (function(_super) {
    ...
    function KeyMaterial(_arg) {
      var userid;
      this.key = _arg.key, this.timestamp = _arg.timestamp, userid = _arg.userid, this.passphrase = _arg.passphrase, this.skm = _arg.skm, this.opts = _arg.opts, this.flags = _arg.flags;
      this.userids = [];
      if (userid != null) {
        this.userids.push(new UserID(userid));
      }
      this.sigs = {
        by_self: [],
        by_primary: {}
    ...
    KeyMaterial.prototype.self_sign_key = function(_arg, cb) {
      var err, lifespan, uidp, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      ...
      (function(__iced_k) {
        if (_this.key.can_sign()) {
          ...
          return __iced_k(err = new Error("Cannot sign key --- don't have a private key"));
        }
      })(function() {
        return cb(err);
      });
    ...
    KeyMaterial.prototype._self_sign_key = function(_arg, cb) {
      var err, lifespan, payload, sig, sigpkt, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
