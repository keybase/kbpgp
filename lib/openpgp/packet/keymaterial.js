...
(function() {
  ...
  KeyMaterial = (function(_super) {
    ...
    function KeyMaterial(_arg) {
      this.key = _arg.key, this.timestamp = _arg.timestamp, this.userid = _arg.userid, this.passphrase = _arg.passphrase, this.skm = _arg.skm, this.opts = _arg.opts, this.flags = _arg.flags;
      if (this.userid != null) {
    ...
    KeyMaterial.prototype._sign_subkey_with_primary = function(_arg, cb) {
      ...
      sigpkt = new Signature({
        ...
        key: this.key,
        hashed_subpackets: [new S.CreationTime(lifespan.generated), new S.KeyExpirationTime(lifespan.expire_in), new S.KeyFlags([this.flags])],
        unhashed_subpackets: [
    ...
    KeyMaterial.prototype.get_flags_subpacket = function() {
      var _ref3, _ref4, _ref5, _ref6;
      return (_ref3 = this.signed || this.self_sig) != null ? (_ref4 = _ref3.sig) != null ? (_ref5 = _ref4.subpacket_index) != null ? (_ref6 = _ref5.hashed) != null ? _ref6[C.sig_subpacket.key_flags] : void 0 : void 0 : void 0 : void 0;
    };

    KeyMaterial.prototype.get_flags = function() {
      var _ref3;
      return ((_ref3 = this.get_flags_subpacket()) != null ? _ref3.all_flags() : void 0) || 0;
    };

    KeyMaterial.prototype.fulfills_flags = function(flags) {
      var _ref3;
      return (_ref3 = this.get_flags_subpacket()) != null ? _ref3.has_flags(flags) : void 0;
    };
