...
(function() {
  ...
  KeyMaterial = (function(_super) {
    ...
    KeyMaterial.prototype.add_designee = function(rev_key) {
      return (this.desig_revokers || (this.desig_revokers = [])).push(rev_key);
    };
    ...
    KeyMaterial.prototype.get_designated_revocations = function() {
      var revocation_matches_designee;
      if (!((this.unverified_revocations != null) && (this.desig_revokers != null))) {
        return [];
      }
      revocation_matches_designee = function(revocation, designee) {
        var get_key_id, keyid;
        get_key_id = function(fingerprint) {
          return fingerprint.slice(12, 20);
        };
      ...
      return this.unverified_revocations.filter((function(_this) {
        return function(sig) {
          return _this.desig_revokers.find(revocation_matches_designee.bind(_this, sig));
        };
      })(this));
    };
