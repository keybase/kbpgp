...
(function() {
  var ASP, C, ECDSA, Encryptor, Engine, K, KeyBlock, KeyFetched, KeyFetcher, KeyManager, KeyManagerInterface, Lifespan, Message, P3SKB, PgpEngine, Primary, RSA, SignatureEngine, Subkey, assert_no_nulls, athrow, box, bufeq_secure, bufferify, decode, encode, iced, katch, make_esc, opkts, ops_to_keyflags, parse, read_base64, unbox, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  _ref = require('../util'), athrow = _ref.athrow, assert_no_nulls = _ref.assert_no_nulls, ASP = _ref.ASP, katch = _ref.katch, bufeq_secure = _ref.bufeq_secure, unix_time = _ref.unix_time, bufferify = _ref.bufferify;
  ...
  _ref3 = require('../keybase/encode'), read_base64 = _ref3.read_base64, unbox = _ref3.unbox, box = _ref3.box;
