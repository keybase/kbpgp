...
(function() {
  var ASP, C, ECDSA, Encryptor, Engine, K, KeyBlock, KeyFetched, KeyFetcher, KeyManager, KeyManagerInterface, Lifespan, Message, P3SKB, PgpEngine, Primary, RSA, SignatureEngine, Subkey, assert_no_nulls, athrow, bufeq_secure, bufferify, decode, encode, format_pgp_fingerprint_2, iced, katch, lifespan_from_keywrapper_and_time, make_esc, opkts, ops_to_keyflags, parse, read_base64, unix_time, unseal, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  Engine = (function() {
    ...
    Engine.prototype.merge_subkey = function(k) {
      var ekid, kw;
      ekid = k.ekid();
      if ((kw = this._index[ekid]) != null) {
        return kw.overwrite_with(k);
      } else {
        this._index[ekid] = k;
    ...
    Engine.prototype.merge_public = function(pgpeng2) {
      this.primary.overwrite_with(pgpeng2.primary);
      return this.merge_subkeys(pgpeng2);
    };

    Engine.prototype.merge_subkeys = function(pgpeng2) {
      var subkey, _i, _len, _ref5, _results;
      _ref5 = pgpeng2.subkeys;
      _results = [];
      for (_i = 0, _len = _ref5.length; _i < _len; _i++) {
        subkey = _ref5[_i];
        _results.push(this.merge_subkey(subkey));
      }
      return _results;
    };
...
_break()
  ...
  KeyManager = (function(_super) {
    ...
    KeyManager.prototype.merge_subkeys = function(km2) {
      if ((this.pgp != null) && (km2.pgp != null)) {
        return this.pgp.merge_subkeys(km2.pgp);
      }
    };
    ...
    KeyManager.prototype.merge_public = function(km2) {
      if ((this.pgp != null) && (km2.pgp != null)) {
        return this.pgp.merge_public(km2.pgp);
      }
    };
