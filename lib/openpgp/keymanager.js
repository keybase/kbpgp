...
_break()
    ...
    PgpEngine.prototype.find_best_key = function(flags, need_priv) {
      ...
      if (this.key(this.primary).is_revoked()) {
        return null;
      }
      best = null;
  ...
  KeyManager = (function(_super) {
    ...
    KeyManager.prototype.find_verified_designated_revoke = function(fetcher, cb) {
      var err, i, key_id, keymat, km, sig, sigs, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref5, _ref6;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (this.pgp == null) {
        return cb();
      }
      sigs = (_ref5 = this.pgp.primary) != null ? (_ref6 = _ref5._pgp) != null ? _ref6.get_designated_revocations() : void 0 : void 0;
          ...
          _while = function(__iced_k) {
            ...
            if (!(_i < _len)) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  if (err || (typeof km === "undefined" || km === null) || !km.pgp) {
                    (function(__iced_k) {
_continue()
                    })(__iced_k);
                  } else {
