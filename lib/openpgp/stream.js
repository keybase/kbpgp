...
(function() {
  var BaseBurner, BoxTransformEngine, C, Compressed, Literal, SEIPD, UnboxTransformEngine, XbtArmorer, XbtSmartDearmorer, hashmod, iced, make_esc, stream, unix_time, xbt, __iced_k, __iced_k_noop, _ref,
  ...
  _ref = require('./armor'), XbtSmartDearmorer = _ref.XbtSmartDearmorer, XbtArmorer = _ref.XbtArmorer;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase/kbpgp/src/openpgp/stream.iced",
  ...
  UnboxTransformEngine = (function() {
    ...
    UnboxTransformEngine.prototype.init = function(cb) {
      this.chain.push_xbt(new XbtSmartDearmorer({})).push_xbt(SEIPD.new_parse_xbt({
        keyfetch: this.keyfetch
      })).push_xbt(Compressed.new_parse_xbt({})).push_xbt(OnePassSignature.new_parse_xbt({})).push_xbt(Literal.new_parse_xbt({}));
