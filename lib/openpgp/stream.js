...
(function() {
  var BaseBurner, BoxTransformEngine, C, Compressed, Literal, SEIPD, XbtArmorer, hashmod, iced, make_esc, stream, unix_time, xbt, __iced_k, __iced_k_noop,
  ...
  XbtArmorer = require('./armor').XbtArmorer;
  ...
  BoxTransformEngine = (function(_super) {
    ...
    BoxTransformEngine.prototype._read_opts = function(cb) {
      ...
      if ((v = (_ref2 = this.opts) != null ? _ref2.armor : void 0) && ((this.armor = C.message_types[v]) == null)) {
