...
(function() {
  var BaseBurner, BoxTransformEngine, C, Literal, Pipeline, hashmod, iced, make_esc, stream, unix_time, __iced_k, __iced_k_noop,
  ...
  Pipeline = (function(_super) {
    ...
    Pipeline.prototype.xform = function(x) {
      if (this.__last != null) {
        this.__last.pipe(x);
      }
      this.__xforms.push(x);
      return this.__last = x;
    };

    Pipeline.prototype.start = function() {
      var i;
      i = 0;
      this.__last.on('data', function(chunk) {
        return this.push(chunk);
      });
      return this.__last.on('emit', function(err) {
    ...
    Pipeline.prototype._transform = function(chunk, encoding, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.__xforms[0].write(chunk, encoding, __iced_deferrals.defer({
            lineno: 32
          }));
        ...
        return function() {
          (function(__iced_k) {
            ...
            if (_this.signing_key != null) {
              _this.pipeline.xform(_this._make_ops_packet().new_stream({
                sig: _this._make_sig_packet(),
                literal: literal
              }));
            } else {
              _this.pipeline.xform(literal.new_stream());
            }
