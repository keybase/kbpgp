...
(function() {
  var C, KeyBlock, Message, OPS, Warnings, armor, asyncify, athrow, bufeq_secure, do_message, hashmod, iced, import_key_pgp, konst, make_esc, parse, unix_time, util, verify_clearsign, verify_detached, __iced_k, __iced_k_noop, _ref;
  ...
  asyncify = require('iced-utils').util.asyncify;
  ...
  Message = (function() {
    function Message(_arg) {
      this.key_fetch = _arg.key_fetch, this.data_fn = _arg.data_fn, this.data = _arg.data;
      this.literals = [];
    ...
    Message.prototype.parse = function(raw, cb) {
    ...
    Message.prototype._verify_signature = function(_arg, cb) {
      var err, packets, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      packets = _arg.packets;
      (function(_this) {
        ...
        return (function(__iced_k) {
          switch (msg.type) {
            ...
            case C.message_types.signature:
              ...
              break;
            default:
              return __iced_k(err = new Error("Needed a 'generic', 'clearsign', or 'signature' PGP message, got " + type));
          }
        });
      })(this)((function(_this) {
        return function() {
  ...
  exports.do_message = do_message = function(_arg, cb) {
    var armored, data, data_fn, esc, keyfetch, literals, msg, proc, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    armored = _arg.armored, keyfetch = _arg.keyfetch, data_fn = _arg.data_fn, data = _arg.data;
    ...
    (function(_this) {
      return (function(__iced_k) {
        ...
        asyncify(armor.decode(armored), esc(__iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
      ...
      return function() {
        ...
        (function(__iced_k) {
          ...
          proc.parse_and_process(msg, esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                return literals = arguments[0];
              };
