...
(function() {
  var C, KeyBlock, Literal, Message, OPS, Warnings, armor, athrow, bufeq_secure, do_message, iced, import_key_pgp, konst, make_esc, parse, util, __iced_k, __iced_k_noop, _ref;
  ...
  _ref = require('../util'), athrow = _ref.athrow, Warnings = _ref.Warnings, bufeq_secure = _ref.bufeq_secure;
  ...
  KeyBlock = (function() {
          ...
          if (err == null) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/max/src/kbpgp/src/openpgp/processor.iced",
    ...
    KeyBlock.prototype._verify_sigs = function(cb) {
      var err, i, iid, n_sigs, p, pid, tmp, working_set, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      working_set = [];
                    ...
                    (function(__iced_k) {
                      if (!bufeq_secure((iid = p.get_issuer_key_id()), (pid = _this.primary.get_key_id()))) {
                        ...
                        (function(__iced_k) {
                          ...
                          return __iced_k(typeof tmp !== "undefined" && tmp !== null ? (console.log("Error in signature verification: " + (tmp.toString())), err = tmp) : _this.verified_signatures.push(p));
                        });
                      }
                    })(__iced_k);
                  }
  ...
  Message = (function() {
    ...
    Message.prototype.verify_clearsign = function(packets, clearsign, cb) {
      var dp, esc, literals, obj, sig, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      esc = make_esc(cb, "Message:process");
      if ((packets.length !== 0) || (sig = packets[0]).tag !== C.packet_tags.signature) {
        athrow(new Error("For a clearsign signature, expected only one packet of type 'signature'"), esc(__iced_deferrals.defer({
          lineno: 274
        })));
      }
      dp = new Literal({
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this.key_fetch.fetch([sig.get_key_id()], konst.ops.verify, esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
        ...
        return function() {
          ...
          (function(__iced_k) {
            ...
            sig.verify(dp, esc(__iced_deferrals.defer({
              lineno: 278
            })));
            __iced_deferrals._fulfill();
          })(function() {
