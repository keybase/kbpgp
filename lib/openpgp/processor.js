...
(function() {
  var C, KeyBlock, Literal, Message, OPS, Warnings, armor, athrow, bufeq_secure, clearsign, do_message, hashmod, iced, import_key_pgp, konst, make_esc, parse, unix_time, util, __iced_k, __iced_k_noop, _ref;
  ...
  Message = (function() {
    ...
    Message.prototype.trash = function(cb) {
      var data, dp, err, esc, literals, obj, sig, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      esc = make_esc(cb, "Message:process");
      console.log(packets);
      (function(_this) {
        return (function(__iced_k) {
          if ((packets.length !== 1) || (sig = packets[0]).tag !== C.packet_tags.signature) {
            err = new Error("For a clearsign signature, expected only one packet of type 'signature'");
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/Users/max/src/kbpgp/src/openpgp/processor.iced",
                funcname: "Message.trash"
              });
