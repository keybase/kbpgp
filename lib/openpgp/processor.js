...
(function() {
  ...
  Message = (function() {
    ...
    Message.prototype._get_session_key = function(cb) {
      var enc, err, esk_packets, fingerprint, index, key_ids, obj, p, packet, pkcs5, sesskey, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      key_ids = [];
      esk_packets = [];
              ...
              (function(__iced_k) {
                if (err == null) {
                  ...
                  (function(__iced_k) {
                    ...
                    obj.key.decrypt_and_unpad(packet.ekey, {
