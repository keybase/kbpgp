...
(function() {
  ...
  exports.do_message = do_message = function(_arg, cb) {
    var armored, data, data_fn, err, keyfetch, literals, msg, proc, raw, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref1;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    armored = _arg.armored, raw = _arg.raw, keyfetch = _arg.keyfetch, data_fn = _arg.data_fn, data = _arg.data;
    literals = null;
    err = msg = null;
    if (armored != null) {
