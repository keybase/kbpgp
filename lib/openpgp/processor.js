                  ...
                  if (!p.is_signature()) {
                    ...
                    (function(__iced_k) {
                      if (!bufeq_secure((iid = p.get_issuer_key_id()), (pid = _this.primary.get_key_id()))) {
                        ...
                        n_sigs++;
                        _this.warnings.push("Skipping signature by another issuer: " + (iid != null ? iid.toString('hex') : void 0) + " != " + (pid != null ? pid.toString('hex') : void 0));
                        return __iced_k(console.log("Skipping signature by another issuer: " + (iid != null ? iid.toString('hex') : void 0) + " != " + (pid != null ? pid.toString('hex') : void 0)));
                      } else {
                        n_sigs++;
