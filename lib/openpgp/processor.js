...
(function() {
  var C, KeyBlock, Message, OPS, SRF, Warnings, armor, athrow, bufeq_secure, do_message, hashmod, iced, import_key_pgp_ct, katch, konst, make_esc, parse, unix_time, util, verify_clearsign, verify_detached, __iced_k, __iced_k_noop, _ref;
  ...
  import_key_pgp_ct = require('../symmetric').import_key_pgp_ct;
          ...
          if (err == null) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/michal/SourceCode/keybase/go/src/github.com/keybase/kbpgp/src/openpgp/processor.iced",
...
_continue()
  ...
  Message = (function() {
    ...
    Message.prototype._get_session_key = function(cb) {
      var enc, err, esk_packets, fingerprint, index, key_ids, key_material, km, p, packet, pkcs5, privk, sesskey, unpad, valid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      key_ids = [];
      esk_packets = [];
      ...
      (function(_this) {
              ...
              (function(__iced_k) {
                if (err == null) {
                  ...
                  (function(__iced_k) {
                    ...
                    return __iced_k(err == null ? (_this.encryption_subkey = key_material, (sesskey = unpad.ret, valid = unpad.valid, pkcs5 = unpad.pkcs5, unpad)) : void 0);
                  });
                } else {
                  return __iced_k();
                }
        ...
        return function() {
          return cb(err, enc, valid, sesskey, pkcs5);
        };
      })(this));
    };
    ...
    Message.prototype._decrypt_with_session_key = function(valid_key, sesskey, fallback_key, edat, pkcs5, cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      _ref1 = import_key_pgp_ct(valid_key, sesskey, fallback_key, pkcs5), valid = _ref1[0], cipher = _ref1[1];
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
    ...
    Message.prototype._decrypt = function(cb) {
      var edat, esc, fallback_key, is_enc, packets, pkcs5, plaintext, sesskey, valid_key, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
        ...
        return (function(__iced_k) {
          ...
          _this._get_session_key(esc(__iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
                is_enc = arguments[0];
                valid_key = arguments[1];
                sesskey = arguments[2];
                return pkcs5 = arguments[3];
              };
            })(),
            lineno: 229
          })));
            ...
            if (is_enc) {
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  SRF().random_bytes(32, __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        return fallback_key = arguments[0];
                      };
                    })(),
                    lineno: 234
                  }));
                  ...
                  (function(__iced_k) {
                    ...
                    _this._decrypt_with_session_key(valid_key, sesskey, fallback_key, edat, pkcs5, esc(__iced_deferrals.defer({
                      assign_fn: (function() {
                        return function() {
