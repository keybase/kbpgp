...
(function() {
  ...
  exports.Message = Message = (function() {
    function Message(_arg) {
      this.body = _arg.body, this.type = _arg.type, this.comment = _arg.comment, this.version = _arg.version, this.pre = _arg.pre, this.post = _arg.post, this.raw_type = _arg.raw_type;
      this.lines = [];
    }
  ...
  Parser = (function() {
    ...
    Parser.prototype.parse_type = function() {
      ...
      return this.ret.raw_type = this.type;
    };
