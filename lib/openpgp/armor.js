...
(function() {
  ...
  XbtTokenizer = (function(_super) {
    ...
    XbtTokenizer.prototype._v_line_chunk = function(_arg, cb) {
      ...
      tok = data == null ? null : (s = data.toString('utf8'), (m = s.match(/^-{5} (BEGIN|END) PGP (\w+) -{5}$/)) != null ? {
        type: 'frame',
        begin: m[1] === 'BEGIN',
        msg_type: m[2]
      } : (m = s.match(/^(\w+): (.*)$/)) != null ? {
  ...
  exports.XbtDearmorer = XbtDearmorer = (function(_super) {
    ...
    XbtDearmorer.prototype._v_line_chunk = function(_arg, cb) {
      ...
      if (tok != null) {
        switch (this._state) {
          ...
          case 1:
            if (tok.type === 'comment') {
              this._comments.push([tok.name, tok.value]);
      ...
      if (!eof) {
        ...
        chksum = uint_to_buffer(32, this._crc24).slice(1, 4).toString('base64');
