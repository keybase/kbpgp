...
(function() {
  var C, Ch, MT, Parser, armor, bufeq_fast, decode, k, katch, r_type_table, type_table, uint_to_buffer, v, xbt, _ref,
  ...
  exports.XbtArmorer = xbt.InBlocker = (function() {
    function InBlocker(_arg) {
      var type;
      type = _arg.type;
      ...
      InBlocker.__super__.constructor.call(this, this._in_width);
      this._crc = null;
    }

    InBlocker.prototype._v_init = function(cb) {
      var buf, hdr;
    ...
    InBlocker.prototype._v_inblock_chunk = function(_arg, cb) {
