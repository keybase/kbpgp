...
(function() {
  var C, Ch, MT, Parser, XbtArmorer, XbtDearmorDemux, XbtDearmorer, XbtTokenizer, armor, bufeq_fast, decode, iced, k, katch, r_type_table, type_table, uint_to_buffer, v, xbt, __iced_k, __iced_k_noop, _ref,
  ...
  exports.XbtArmorer = XbtArmorer = (function(_super) {
    ...
    XbtArmorer.prototype.xbt_type = function() {
      return "Armorer";
    };
  ...
  exports.XbtDearmorDemux = XbtDearmorDemux = (function(_super) {
    __extends(XbtDearmorDemux, _super);

    function XbtDearmorDemux(mt) {
      this._prefix = "-----BEGIN PGP";
      XbtDearmorDemux.__super__.constructor.apply(this, arguments);
    }

    XbtDearmorDemux.prototype.xbt_type = function() {
      return "XbtDearmorDemux";
    };

    XbtDearmorDemux.prototype.peek_bytes = function() {
      return this._prefix.length;
    };

    XbtDearmorDemux.prototype._demux = function(_arg, cb) {
      var data, eof, ret;
      data = _arg.data, eof = _arg.eof;
      if ((data != null) && data.toString('utf8').indexOf(this._prefix) === 0) {
  ...
  XbtTokenizer = (function(_super) {
    ...
    XbtTokenizer.prototype.xbt_type = function() {
      return "XbtTokenizer";
    };
          ...
          if ((tok != null) || eof) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/max/src/keybase/kbpgp/src/openpgp/armor.iced",
  ...
  exports.XbtDearmorer = XbtDearmorer = (function(_super) {
    ...
    XbtDearmorer.prototype.xbt_type = function() {
      return "XbtDearmor";
    };
