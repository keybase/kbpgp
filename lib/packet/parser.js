...
(function() {
  var C, KeyMaterial, MessageParser, PacketParser, Signature, SlicerBuffer, UserID, err, fs, iced, inspect, out, parse, res, util, __iced_deferrals, __iced_k, __iced_k_noop,
    _this = this;
  ...
  (function(__iced_k) {
    ...
    console.log(err);
    out = parse(res);
    return console.log(inspect(out, {
      depth: null
    }));
  });
