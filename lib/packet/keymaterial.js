...
(function() {
  var AES, C, CreationTime, Issuer, KeyMaterial, Packet, Parser, RSA, S2K, SHA1, SHA256, Signature, UserID, bufeq_secure, bufferify, calc_checksum, decrypt, encode, encrypt, iced, katch, make_time_packet, native_rng, symmetric, triplesec, uint_to_buffer, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3,
  ...
  _ref1 = require('../util'), bufferify = _ref1.bufferify, unix_time = _ref1.unix_time, bufeq_secure = _ref1.bufeq_secure, katch = _ref1.katch, make_time_packet = _ref1.make_time_packet, uint_to_buffer = _ref1.uint_to_buffer, calc_checksum = _ref1.calc_checksum;
  ...
  _ref3 = require('./signature'), CreationTime = _ref3.CreationTime, Issuer = _ref3.Issuer, Signature = _ref3.Signature;
  ...
  KeyMaterial = (function(_super) {
    ...
    KeyMaterial.prototype._self_sign_key = function(cb) {
      var err, payload, sig, sigpkt, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      payload = Buffer.concat([this.to_signature_payload(), this.uidp.to_signature_payload()]);
      sigpkt = new Signature({
        type: C.sig_types.issuer,
        key: this.key,
        hashed_subpackets: [new CreationTime(unix_time()), new Issuer(this.get_key_id())]
      });
      (function(__iced_k) {
    ...
    KeyMaterial.prototype._encode_keys = function(_arg) {
      var armor, private_key, public_key, sig, uidp, _ref4;
      sig = _arg.sig, armor = _arg.armor;
      uidp = this.uidp.write();
      _ref4 = C.message_types, private_key = _ref4.private_key, public_key = _ref4.public_key;
      return {
    ...
    KeyMaterial.prototype.open = function(_arg, cb) {
      ...
      err = null;
      pt = this.skm.s2k_convention !== C.s2k_convention.none ? (key = this.skm.s2k.produce_key(passphrase, this.skm.cipher.key_size), console.log(this.skm.cipher.key_size), console.log(key), decrypt({
  ...
  Parser = (function() {
    ...
    Parser.prototype.parse_public_key_mpis = function() {
      ...
      }).call(this), err = _ref4[0], key = _ref4[1], len = _ref4[2];
      if (err != null) {
        throw err;
      }
