...
(function() {
  var AES, C, CreationTime, Issuer, KeyMaterial, Packet, Parser, RSA, S2K, SHA1, SHA256, Signature, UserID, bufeq_secure, calc_checksum, decrypt, encode, encrypt, iced, katch, make_time_packet, native_rng, symmetric, triplesec, uint_to_buffer, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3,
  ...
  _ref1 = require('../util'), unix_time = _ref1.unix_time, bufeq_secure = _ref1.bufeq_secure, katch = _ref1.katch, make_time_packet = _ref1.make_time_packet, uint_to_buffer = _ref1.uint_to_buffer, calc_checksum = _ref1.calc_checksum;
  ...
  KeyMaterial = (function(_super) {
    ...
    KeyMaterial.prototype._self_sign_key = function(cb) {
      var err, payload, pk, sig, sigpkt, uid8, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      pk = this.public_body();
      uid8 = this.uidp.utf8();
      payload = Buffer.concat([new Buffer([C.signatures.key]), uint_to_buffer(16, pk.length), pk, new Buffer([C.signatures.userid]), uint_to_buffer(32, uid8.length), uid8]);
