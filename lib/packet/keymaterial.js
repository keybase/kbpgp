...
(function() {
  var AES, C, KeyMaterial, Packet, S2K, SHA1, SHA256, Signature, UserID, calc_checksum, encode, encrypt, iced, make_time_packet, native_rng, triplesec, uint_to_buffer, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  _ref1 = require('../util'), make_time_packet = _ref1.make_time_packet, uint_to_buffer = _ref1.uint_to_buffer, calc_checksum = _ref1.calc_checksum;
  ...
  KeyMaterial = (function(_super) {
    ...
    function KeyMaterial(_arg) {
      this.key = _arg.key, this.timestamp = _arg.timestamp, this.userid = _arg.userid, this.passphrase = _arg.passphrase;
    ...
    KeyMaterial.prototype._write_private_enc = function(bufs, priv) {
      ...
      bufs.push(new Buffer([254, C.symmetric_key_algorithms.AES256, C.s2k.salt_iter, C.hash_algorithms.SHA256]));
    ...
    KeyMaterial.prototype._write_private_clear = function(bufs, priv) {
      return bufs.push(new Buffer([0]), priv, uint_to_buffer(16, calc_checksum(priv)));
    };
    ...
    KeyMaterial.prototype._encode_keys = function(_arg) {
      var armor, private_key, public_key, sig, uidp, _ref2;
      sig = _arg.sig, armor = _arg.armor;
      uidp = this.uidp.write();
      _ref2 = C.message_types, private_key = _ref2.private_key, public_key = _ref2.public_key;
      return {
