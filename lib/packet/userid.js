...
(function() {
  var AES, C, Packet, SHA1, SHA256, UserID, calc_checksum, encrypt, native_rng, triplesec, uint_to_buffer, _ref, _ref1,
  ...
  _ref1 = require('../util'), uint_to_buffer = _ref1.uint_to_buffer, calc_checksum = _ref1.calc_checksum;
