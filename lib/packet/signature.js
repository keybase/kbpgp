...
(function() {
  ...
  Signature = (function(_super) {
    ...
    Signature.prototype.write = function(data, cb) {
      var hvalue, payload, prefix, result2, results, ret, sig, _ref2;
      ...
      result2 = Buffer.concat([uint_to_buffer(16, 0), new Buffer([hvalue.readUInt8(0), hvalue.readUInt8(1)]), sig]);
    ...
    Signature.prototype.verify = function(data, cb) {
      var err, payload;
      payload = this.prepare_payload(data).payload;
      return err = this.key.verify_unpad_and_check_hash(this.sig, payload, this.hasher);
    };
