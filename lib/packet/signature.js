...
(function() {
  ...
  ExpirationTime = (function(_super) {
    ...
    ExpirationTime.parse = function(klass, slice) {
      return new klass(this.slice.read_uint32());
    };
  ...
  Preference = (function(_super) {
    ...
    Preference.parse = function(klass, slice) {
      var c, v;
      v = (function() {
        var _i, _len, _ref2, _results;
        _ref2 = this.slice.consume_rest_to_buffer();
        _results = [];
  ...
  SigCreationTime = (function(_super) {
    ...
    SigCreationTime.parse = function(slice) {
      return new SigCreationTime(new Date(this.slice.read_uint32() * 1000));
    };
  ...
  Exporatable = (function(_super) {
    ...
    Exporatable.parse = function(slice) {
      return new Exporatable(this.slice.read_uint8() === 1);
    };
  ...
  Trust = (function(_super) {
    ...
    Trust.parse = function(slice) {
      return new Trust(this.slice.read_uint8(), this.slice.read_uint8());
    };
  ...
  RegularExpression = (function(_super) {
    ...
    RegularExpression.parse = function(slice) {
      return new RegularExpression(slice.consume_rest_to_buffer().toString('utf8'));
    };
  ...
  Revocable = (function(_super) {
    ...
    Revocable.parse = function(slice) {
      return new Revocable(this.slice.read_uint8() === 1);
    };
  ...
  RevocationKey = (function(_super) {
    ...
    RevocationKey.parse = function(slice) {
      var fp, ka, kc;
      kc = this.slice.read_uint8();
      ka = this.slice.read_uint8();
      fp = this.slice.read_buffer(SHA1.output_size);
  ...
  Issuer = (function(_super) {
    ...
    Issuer.parse = function(slice) {
      return new Issuer(this.slice.read_buffer(8));
    };
  ...
  NotationData = (function(_super) {
    ...
    NotationData.parse = function(slice) {
      ...
      flags = this.slice.read_uint32();
      nl = this.slice.read_uint16();
      vl = this.slice.read_uint16();
      name = this.slice.read_buffer(nl);
      value = this.slice.read_buffer(vl);
  ...
  PreferredKeyServer = (function(_super) {
    ...
    PreferredKeyServer.parse = function(slice) {
      return new PreferredKeyServer(this.slice.consume_rest_to_buffer());
    };
  ...
  PrimaryUserId = (function(_super) {
    ...
    PrimaryUserId.parse = function(slice) {
      return new PrimaryUserId(this.slice.read_uint8() === 1);
    };
  ...
  PolicyURI = (function(_super) {
    ...
    PolicyURI.parse = function(slice) {
      return new PolicyURI(this.slice.consume_rest_to_buffer());
    };
  ...
  KeyFlags = (function(_super) {
    ...
    function KeyFlags() {
      _ref8 = KeyFlags.__super__.constructor.apply(this, arguments);
      return _ref8;
    }
  ...
  SignersUserID = (function(_super) {
    ...
    SignersUserID.parse = function(slice) {
      return new SignersUserID(this.slice.consume_rest_to_buffer());
    };
  ...
  ReasonForRevocation = (function(_super) {
    ...
    ReasonForRevocation.parse = function(slice) {
      var flag, reason;
      flag = this.slice.read_uint8();
      reason = this.slice.consume_rest_to_buffer();
  ...
  Features = (function(_super) {
    ...
    function Features() {
      _ref9 = Features.__super__.constructor.apply(this, arguments);
      return _ref9;
    }
  ...
  SignatureTarget = (function(_super) {
    ...
    SignatureTarget.parse = function(slice) {
      var hasher, hval, pka;
      pka = this.slice.read_uint8();
      hasher = alloc_or_throw(this.slice.read_uint8());
      hval = this.slice.read_buffer(ha.output_length);
  ...
  Parser = (function() {
    ...
    Parser.prototype.parse_v3 = function() {
      ...
      this.hash_alg = alloc_or_throw(this.slice.read_uint8());
