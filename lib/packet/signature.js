...
(function() {
  ...
  Signature = (function(_super) {
    ...
    function Signature(_arg) {
      this.key = _arg.key, this.hasher = _arg.hasher, this.key_id = _arg.key_id, this.sig_data = _arg.sig_data, this.public_key_class = _arg.public_key_class, this.signed_hash_value_hash = _arg.signed_hash_value_hash, this.subpackets = _arg.subpackets, this.time = _arg.time, this.sig = _arg.sig, this.type = _arg.type;
      if (this.hasher == null) {
        this.hasher = SHA512;
      }
    ...
    Signature.prototype.prepare_payload = function(data) {
      var flatsp, hvalue, payload, result, s, trailer;
      ...
      result = Buffer.concat([new Buffer([C.versions.signature.V4, this.type, this.key.type, this.hasher.type]), uint_to_buffer(16, flatsp.length), flatsp]);
    ...
    Signature.prototype.write = function(data, cb) {
      var hvalue, payload, result, result2, results, ret, sig, trailer, _ref2;
      _ref2 = this.prepare_payload(data), result = _ref2.result, trailer = _ref2.trailer, payload = _ref2.payload, hvalue = _ref2.hvalue;
      sig = this.key.pad_and_sign(payload, {
        hasher: this.hasher
      });
      result2 = Buffer.concat([new Buffer([0, 0, hvalue.readUInt8(0), hvalue.readUInt8(1)]), sig]);
