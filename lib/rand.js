...
(function() {
  var BigInteger, Lock, MRF, MediumRandomFountain, SRF, StrongRandomFountain, iced, native_rng, nbi, prng, __iced_k, __iced_k_noop, _mrf, _ref, _srf;

  iced = require('iced-coffee-script/lib/coffee-script/iced').runtime;
  __iced_k = __iced_k_noop = function() {};

  _ref = require('bn'), nbi = _ref.nbi, BigInteger = _ref.BigInteger;
  ...
  MediumRandomFountain = (function() {
    ...
    MediumRandomFountain.prototype.random_zn = function(n) {
      var i;
      while (true) {
        i = nbi().random_nbit(n.bitLength(), this);
    ...
    StrongRandomFountain.prototype.random_nbit = function(nbits, cb) {
      ...
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          ret = nbi().random_nbit(nbits, _this);
          _this.lock.release();
          return cb(ret);
        });
      });
