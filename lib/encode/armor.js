...
(function() {
  var C, b64e, bufeq_fast, crc_table, createcrc24, encode, formatCheckSum, frame, getCheckSum, header, line, strip, uint_to_buffer, verifyCheckSum, _ref;



  _ref = require('../util'), bufeq_fast = _ref.bufeq_fast, uint_to_buffer = _ref.uint_to_buffer;
  ...
  encode = function(type, data) {
    ...
    switch (type) {
      ...
      case mt.private_key:
        ...
        f = frame("" + t + " KEY BLOCK");
        return f.begin.concat(header(), line(), b64e(data), formatCheckSum(data), f.end);
    }
  };
  ...
  formatCheckSum = function(data) {
    return line("=" + getCheckSum(data));
  };

  verifyCheckSum = function(data, checksum) {
    return bufeq_fast(getCheckSum(data), checksum);
  };
