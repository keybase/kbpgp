...
(function() {
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.encrypt = function(m, cb) {
      var c, g, k, p, y, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref4;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      _ref4 = this.pub, g = _ref4.g, y = _ref4.y, p = _ref4.p;
      (function(_this) {
        return (function(__iced_k) {
          ...
          SRF().random_zn(p.subtract(bn.nbv(2)), __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
        ...
        return function() {
          ...
          c = [g.modPow(k, p), y.modPow(k, p).multiply(m).mod(p)];
          return cb(c);
        };
      })(this));
    };

    Pub.prototype.decrypt = function(c, cb) {
      var p, ret;
      p = this.pub.p;
  ...
  Pair = (function(_super) {
    ...
    Pair.prototype.pad_and_encrypt = function(data, cb) {
      var c, c_mpis, err, i, m, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = ret = null;
      (function(_this) {
    ...
    Pair.prototype.decrypt_and_unpad = function(ciphertext, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          var _ref4;
          b = m.to_padded_octects(_this.pub.p);
