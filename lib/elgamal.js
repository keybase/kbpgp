...
(function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/michal/SourceCode/keybase/go/src/github.com/keybase/kbpgp/src/elgamal.iced",
  ...
  Pair = (function(_super) {
    ...
    Pair.prototype.decrypt_and_unpad = function(ciphertext, params, cb) {
      var b, err, m, ret, valid, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = ret = null;
      valid = false;
      (function(_this) {
        ...
        return function() {
          ...
          if (err == null) {
            ...
            _ref4 = eme_pkcs1_decode(b), err = _ref4[0], valid = _ref4[1], ret = _ref4[2];
          }
          return cb(err, {
            valid: valid,
            ret: ret
