...
(function() {
  var Base, Chain, Demux, Gets, InBlocker, Passthrough, Queue, ReadBufferer, ReverseAdapter, SimpleInit, StreamAdapter, Waitpoint, assert, buf_indices_of, bufcat, iced, make_esc, stream, __iced_k, __iced_k_noop, _ref,
  ...
  Chain = (function(_super) {
    ...
    Chain.prototype.chunk = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _while = function(__iced_k) {
            ...
            if (!(i < _len)) {
              ...
              l = _ref1[i];
              console.log("+ " + _this._iters + "." + i + " CHAIN link");
        ...
        return function() {
          console.log("chunk chain is done! -> " + eof + " -> " + (out != null ? out.length : void 0) + " -> " + (out != null ? out.toString('hex') : void 0));
          return cb(null, out);
        };
      })(this));
    };
  ...
  ReadBufferer = (function(_super) {
    ...
    ReadBufferer.prototype._run_parse_loop = function() {
      ...
      if (this._first) {
        ...
        (function(_this) {
          ...
          return function() {
            return __iced_k((tmp = _this._last_cb) ? (_this._last_cb = null, _this._flow_mode ? _this._chunk_flow_mode({
              eof: true
            }, tmp) : tmp(_this._err, _this._flush_out())) : void 0);
          };
        })(this));
      } else {
        return __iced_k();
    ...
    ReadBufferer.prototype.chunk = function(_arg, cb) {
      ...
      console.log("+ " + this._rbc + " (" + this._flow_mode + ") Chunk in ReadBufferer...");
      err = out = null;
      (function(_this) {
        return (function(__iced_k) {
          if (_this._err) {
            console.log("A0");
            return __iced_k(err = _this._err);
          } else {
            (function(__iced_k) {
              if (_this._flow_mode) {
                console.log("A1");
        ...
        return function() {
          console.log("- " + _this._rbc + " Chunk in ReadBufferer");
          return cb(err, out);
        };
      })(this));
    };
          ...
          (function(__iced_k) {
            if (_this._sink != null) {
              (function(__iced_k) {
                ...
                out = bufcat([_this._flush_out(), out]);
                return __iced_k(console.log("demux out --> " + out.length + " -> " + (out.toString('hex'))));
              });
            } else {
              return __iced_k();
            }
  ...
  Queue = (function() {
    ...
    Queue.prototype.pull = function(n, peek) {
      ...
      if (n > 0 && !peek) {
        return this._made_room();
      }
    };

    Queue.prototype.flush = function(peek) {
      var list, out;
      list = this._buffers.length && this._i ? [this._buffers[0].slice(this._i), this._buffers.slice(1)] : this._buffers;
  ...
  ReadBufferer = (function(_super) {
    ...
    function ReadBufferer(_arg) {
      var bufsz, sink;
      sink = _arg.sink, bufsz = _arg.bufsz;
      this._sink = sink;
    ...
    ReadBufferer.prototype._push_data = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this._inq.wait_for_room(__iced_deferrals.defer({
            lineno: 707
          }));
          __iced_deferrals._fulfill();
        });
        ...
        return function() {
          _this._inq.push(data);
          return cb(null);
        };
      })(this));
    };

    ReadBufferer.prototype.set = function(_arg) {
      var inq, sink, source;
      source = _arg.source, inq = _arg.inq, sink = _arg.sink;
      if (source != null) {
        this._source = source;
      }
      if (inq != null) {
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            return cb(_this._err, bufcat([_this._outq.flush(), outdata]));
          });
        };
      })(this));
    };
    ...
    ReadBufferer.prototype._read = function(_arg, cb) {
      var data, err, exactly, max, min, peek, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this._inq.wait_for_data(min, (function() {
        ...
        return function() {
          data = typeof err !== "undefined" && err !== null ? null : _this._inq.pull(max, peek);
          return cb(err, data);
        };
      })(this));
    };
