...
(function() {
  var Base, Chain, DEBUG, Demux, Gets, HashThrough, InBlocker, Passthrough, Queue, ReadBufferer, ReverseAdapter, SimpleInit, StreamAdapter, Waitpoint, assert, buf_indices_of, bufcat, iced, make_esc, stream, __iced_k, __iced_k_noop, _ref,
  ...
  Base = (function() {
    ...
    Base.prototype.get_debug = function() {
      var d, p;
      if (!DEBUG) {
        return null;
      } else {
    ...
    Base.prototype._debug_buffer = function(b, debug) {
      var col, dat, hex;
      if (b != null) {
        hex = b.toString('hex');
        col = 80;
        dat = debug === 1 ? hex.slice(0, col) + (hex.length > col ? "..." : '') : hex;
        return "[" + b.length + "]{" + dat + "}";
      } else {
        return "[]";
      }
    ...
    Base.prototype._chunk_debug_pre = function(_arg) {
      ...
      data = _arg.data, eof = _arg.eof;
      if ((di = this.get_debug()) != null) {
        prfx = ((function() {
          var _i, _ref1, _results;
          _results = [];
          for (_i = 0, _ref1 = di.level; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; 0 <= _ref1 ? _i++ : _i--) {
            _results.push("+");
          }
          return _results;
        })()).join('');
        return this._chunk_debug_msg(prfx, "eof=" + eof + ": " + (this._debug_buffer(data, di.debug)));
      }
    };
    ...
    Base.prototype._chunk_debug_post = function(_arg) {
      ...
      if ((di = this.get_debug()) != null) {
        ...
        msg_parts.push(this._debug_buffer(data, di.debug));
        return this._chunk_debug_msg(prfx, msg_parts.join(": "));
      }
    };

    Base.prototype._chunk_debug_msg = function(pre, post) {
      return console.log([pre, "" + this._xbt_type + "#" + this._obj_id, post].join(' '));
    };
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (eof) {
            ...
            (function(__iced_k) {
              if (_this._inq.n_bytes() >= _this.block_size) {
                (function(__iced_k) {
                  __iced_deferrals = new iced.Deferrals(__iced_k, {
                    parent: ___iced_passed_deferral,
                    filename: "/home/max/src/keybase/kbpgp/src/xbt.iced",
  ...
  ReadBufferer = (function(_super) {
    ...
    ReadBufferer.prototype._stream_to = function(next, cb) {
      var data, out, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      this._sink = next;
    ...
    ReadBufferer.prototype._read = function(_arg, cb) {
      var data, err, exactly, i, max, min, peek, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
