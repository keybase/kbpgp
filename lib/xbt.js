...
(function() {
  var Base, Chain, DEBUG, Demux, Gets, HashThrough, InBlocker, Lock, Passthrough, Queue, ReadBufferer, ReverseAdapter, SimpleInit, StreamAdapter, Waitpoint, assert, buf_indices_of, bufcat, iced, make_esc, stream, __iced_k, __iced_k_noop, _ref,
  ...
  Base = (function() {
    ...
    Base.prototype.get_debug = function() {
      if (this._debug_info == null) {
        this._debug_info = this._get_debug_info();
      }
    ...
    Base.prototype._debug_prefix = function(c) {
      return ((function() {
        ...
        _results = [];
        for (_i = 0, _ref1 = this.get_debug().level; 0 <= _ref1 ? _i <= _ref1 : _i >= _ref1; 0 <= _ref1 ? _i++ : _i--) {
          _results.push(c);
        }
        return _results;
      }).call(this)).join('');
