...
(function() {
  var Base, Chain, Demux, Gets, HashThrough, InBlocker, Passthrough, Queue, ReadBufferer, ReverseAdapter, SimpleInit, StreamAdapter, Waitpoint, assert, buf_indices_of, bufcat, iced, make_esc, stream, __iced_k, __iced_k_noop, _ref,
  ...
  Base = (function() {
    ...
    Base.prototype._chunk_debug_pre = function(_arg) {
      var data, eof;
      data = _arg.data, eof = _arg.eof;
      return this._chunk_debug_msg("+", "" + eof + ":" + (data != null ? data.toString('hex') : void 0));
    };

    Base.prototype._chunk_debug_post = function(_arg) {
      var data, err;
      err = _arg.err, data = _arg.data;
      return this._chunk_debug_msg("-", "" + (err != null ? 'ERR=(' + (err != null ? err.message : void 0) + ')' : '') + " " + (data != null ? data.toString('hex') : void 0));
    };
