...
(function() {
  ...
  Queue = (function() {
    ...
    Queue.prototype.wait_for_data = function(_arg, cb) {
      var err, is_eof, n, peek, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      n = _arg.n, is_eof = _arg.is_eof, peek = _arg.peek;
      (function(_this) {
        return (function(__iced_k) {
          var _results, _while;
          _results = [];
        ...
        return function() {
          err = (_this.n_bytes() >= n) || peek ? null : new Error("EOF before " + n + " bytes");
          return cb(err);
        };
      })(this));
    };
    ...
    ReadBufferer.prototype._emit = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          ...
          _this._outq.wait_then_push(data, __iced_deferrals.defer({
            lineno: 644
          }));
          __iced_deferrals._fulfill();
        });
