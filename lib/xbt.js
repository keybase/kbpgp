...
(function() {
  ...
  Base = (function() {
    ...
    function Base() {
      ...
      this._debug = 0;
      this._stop_waitpoint = new Waitpoint;
    }
  ...
  ReadBufferer = (function(_super) {
    ...
    ReadBufferer.prototype._stream_to = function(next, cb) {
      var data, err, out, rv, which, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      this._sink = next;
      ...
      (function(_this) {
        ...
        return function() {
          (function(__iced_k) {
            ...
            _this._source_eof_waitpoint.wait(rv.id(0).defer({
              lineno: 678,
              context: __iced_deferrals
            }));
            _this._sink._stop_waitpoint.wait(rv.id(1).defer({
              lineno: 679,
              context: __iced_deferrals
            }));
            (function(__iced_k) {
