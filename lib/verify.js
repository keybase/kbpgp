...
(function() {
  ...
  exports.GenericKey = GenericKey = (function() {
    ...
    GenericKey.prototype._verify_cb = function(s, cb) {
      var esc, payload, sig_eng, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    ...
    GenericKey.prototype.verify = function(s) {
      return promisify(this._verify_cb.bind(this))(s);
    };
