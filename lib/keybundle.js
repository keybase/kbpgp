...
(function() {
  var C, Encryption, Engine, K, KeyBundle, KeybaseEngine, Lifespan, PgpEngine, Primary, RSA, Subkey, UserIds, bufferify, decode, encode, iced, kpkts, make_esc, opkts, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  UserIds = (function() {
    ...
    UserIds.prototype.get_keybase = function() {
      return "" + this.keybase + "@keybase.io";
    };

    UserIds.prototype.get_openpgp = function() {
      return this.openpgp || this.get_keybase();
    };
  ...
  PgpEngine = (function(_super) {
    ...
    PgpEngine.prototype.userid_packet = function() {
      if (this._uidp == null) {
        this._uidp = new opkts.UserID(this.userids.get_keybase());
      }
      return this._uidp;
    };
    ...
    PgpEngine.prototype._v_sign_subkey = function(_arg, cb) {
      var arg, asp, err, primary_binding, sig, subkey, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      asp = _arg.asp, subkey = _arg.subkey;
      arg = {
        primary: this.primary._pgp,
      ...
      (function(__iced_k) {
        ...
        subkey._pgp.sign_primary(arg, __iced_deferrals.defer({
          assign_fn: (function() {
            return function() {
              err = arguments[0];
        ...
        (function(__iced_k) {
          if (typeof err === "undefined" || err === null) {
            ...
            (function(__iced_k) {
              ...
              _this.primary._pgp.sign_subkey(arg, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    err = arguments[0];
    ...
    PgpEngine.prototype.export_public_to_client = function() {
      var packets, subkey, _i, _len, _ref3;
  ...
  KeyBundle = (function() {
    ...
    KeyBundle.prototype.sign = function(_arg, cb) {
      var asp, esc, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      asp = _arg.asp;
      ...
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/keybundle.iced",
          funcname: "KeyBundle.sign"
        });
        _this._self_sign_primary({
          asp: asp
        }, esc(__iced_deferrals.defer({
          lineno: 234
        })));
