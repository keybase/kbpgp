...
(function() {
  ...
  ui32a_to_ui8a = require('./util').ui32a_to_ui8a;
  ...
  CAST5 = (function() {
    ...
    CAST5.prototype.encrypt = function(wa_src) {
      var out;
      out = this._encrypt_ui8a(ui32a_to_ui8a(wa_src));
      return WordArray.from_buffer(new Buffer(out));
    };

    CAST5.prototype.encryptBlock = function(wa_src, offset) {
      if (offset == null) {
        offset = 0;
      }
      return this.encrypt(wa_src);
    };

    CAST5.prototype.decrypt = function(wa_src) {
      var out;
      out = this._decrypt_ui8a(ui32a_to_ui8a(wa_src));
      return WordArray.from_buffer(new Buffer(out));
    };

    CAST5.prototype.decryptBlock = function(wa_src, offset) {
      if (offset == null) {
        offset = 0;
      }
      return this.decrypt(wa_src);
    };
