...
(function() {
  var CAST5, G, Global, WordArray, buffer_to_ui8a;
  ...
  CAST5 = (function() {
    ...
    CAST5.prototype.encrypt = function(wa_src, offset) {
      var out;
      if (offset == null) {
        offset = 0;
      }
      out = this._encrypt_ui8a(buffer_to_ui8a(wa_src.to_buffer()));
      return WordArray.from_buffer(new Buffer(out));
    };

    CAST5.prototype.decrypt = function(wa_src, offset) {
      var out;
      if (offset == null) {
        offset = 0;
      }
      out = this._decrypt_ui8a(buffer_to_ui8a(wa_src.to_buffer()));
      return WordArray.from_buffer(new Buffer(out));
    };
