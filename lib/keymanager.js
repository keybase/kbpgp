...
(function() {
  ...
  Engine = (function() {
    ...
    Engine.prototype.is_encrypted = function() {
      var k, _i, _len, _ref4;
      _ref4 = this._all_keys();
      for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
        k = _ref4[_i];
        if (this.key(k).is_encrypted()) {
          return true;
        }
      }
      return false;
  ...
  KeyManager = (function() {
    ...
    KeyManager.prototype.is_pgp_encrypted = function() {
      return this.pgp.is_encrypted();
    };

    KeyManager.prototype.is_keybase_encrypted = function() {
      return this.keybase.is_encrypted();
    };
