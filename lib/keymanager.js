...
(function() {
  ...
  Engine = (function() {
    ...
    Engine.prototype.merge_private = function(eng2) {
      ...
      err = null;
      if (!this._merge_1_private(this.primary, eng2.primary)) {
        ...
        for (i = _i = 0, _len = _ref4.length; _i < _len; i = ++_i) {
          key = _ref4[i];
          if (err == null) {
            if (!this._merge_1_private(key, eng2.subkeys[i])) {
    ...
    Engine.prototype.open_keys = function(_arg, cb) {
      ...
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/keymanager.iced",
          funcname: "Engine.open_keys"
        });
        _this.key(_this.primary).open({
          asp: asp,
          tsenc: tsenc,
  ...
  PgpEngine = (function(_super) {
    ...
    PgpEngine.prototype._v_merge_private = function(k1, k2) {
      return k1._pgp.merge_private(k2._pgp);
    };
  ...
  KeybaseEngine = (function(_super) {
    ...
    KeybaseEngine.prototype._v_merge_private = function(k1, k2) {
      return k1._keybase.merge_private(k2._keybase);
    };
    ...
    KeyManager.prototype.open_keybase = function(_arg, cb) {
      ...
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/keymanager.iced",
          funcname: "KeyManager.open_keybase"
        });
        _this.keybase.open_keys({
          tsenc: tsenc,
          asp: asp
        }, __iced_deferrals.defer({
          assign_fn: (function() {
