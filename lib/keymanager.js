...
(function() {
  var ASP, C, Engine, K, KeyBlock, KeyManager, Lifespan, Message, P3SKB, PgpEngine, Primary, RSA, Subkey, UserId, assert_no_nulls, box, bufeq_secure, bufferify, decode, encode, iced, katch, make_esc, opkts, ops_to_keyflag, parse, read_base64, unbox, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3,
  ...
  ops_to_keyflag = require('./openpgp/util').ops_to_keyflag;
