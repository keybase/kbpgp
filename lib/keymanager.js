...
(function() {
  var C, Encryption, Engine, K, KeyBlock, KeyManager, KeybaseEngine, Lifespan, PgpEngine, Primary, RSA, Subkey, UserIds, bufferify, decode, encode, iced, kpkts, make_esc, opkts, parse, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  PgpEngine = (function(_super) {
    ...
    PgpEngine.prototype.export_public = function() {
  ...
  KeybaseEngine = (function(_super) {
    ...
    KeybaseEngine.prototype._v_sign_subkey = function(_arg, cb) {
      ...
      (function(__iced_k) {
        ...
        (function(__iced_k) {
          ...
          p = new kpkts.SubkeyReverseSignature({
            primary: _this.primary,
            subkey: subkey
          });
          (function(__iced_k) {
    ...
    KeybaseEngine.prototype.export_private = function(_arg, cb) {
      var asp, esc, k, key, primary, ret, tsenc, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(__iced_k) {
        __iced_deferrals = new iced.Deferrals(__iced_k, {
          parent: ___iced_passed_deferral,
          filename: "src/keymanager.iced",
          funcname: "KeybaseEngine.export_private"
        });
        _this.primary._keybase.export_private({
          tsenc: tsenc,
          asp: asp
        }, esc(__iced_deferrals.defer({
          assign_fn: (function() {
        ...
        ret.primary = {
          key: primary,
          sigs: {
            keybase: _this.self_sigs.keybase,
            openpgp: _this.self_sigs.openpgp
          }
        };
        (function(__iced_k) {
          var _i, _len, _ref3, _results, _while;
    ...
    KeybaseEngine.prototype.export_public = function(_arg, cb) {
      var asp, k, ret;
      asp = _arg.asp;
      ...
      ret.primary = {
        ...
        sigs: {
          keybase: this.self_sigs.keybase,
          openpgp: this.self_sigs.openpgp
        }
      };
      ret.subkeys = (function() {
  ...
  KeyManager = (function() {
    ...
    KeyManager.import_from_armored_pgp_public = function(_arg, cb) {
        ...
        if (err == null) {
          ...
          (function(__iced_k) {
            __iced_deferrals = new iced.Deferrals(__iced_k, {
              parent: ___iced_passed_deferral,
              filename: "src/keymanager.iced",
              funcname: "KeyManager.import_from_armored_pgp_public"
            });
    ...
    KeyManager.prototype.add_armored_pgp_private = function(_arg, cb) {
      var asp, raw;
      raw = _arg.raw, asp = _arg.asp;
    };

    KeyManager.prototype.open_pgp = function(_arg, cb) {
      var passphrase;
      passphrase = _arg.passphrase;
    };

    KeyManager.prototype.open_keybase = function(_arg, cb) {
      var asp;
      asp = _arg.asp;
    };

    KeyManager.prototype.export_public_to_server = function(_arg, cb) {
      var asp;
      asp = _arg.asp;
    };
    ...
    KeyManager.prototype.export_private_to_server = function(_arg, cb) {
      ...
      (function(__iced_k) {
        ...
        ret = typeof err !== "undefined" && err !== null ? null : {
          pgp: pgp,
          keybase: keybase
        };
        return cb(err, ret);
    ...
    KeyManager.prototype.to_openpgp_packet = function(_arg) {
      var passphrase, tsec;
      tsec = _arg.tsec, passphrase = _arg.passphrase;
    };

    KeyManager.prototype.to_keybase_packet = function(_arg) {
      var passphrase, tsec;
      tsec = _arg.tsec, passphrase = _arg.passphrase;
    };
