...
(function() {
  var ASP, C, Engine, K, KeyBlock, KeyManager, Lifespan, Message, P3SKB, PgpEngine, Primary, RSA, Subkey, UserId, box, bufeq_secure, bufferify, decode, encode, iced, katch, make_esc, opkts, parse, read_base64, unbox, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3,
  ...
  _ref = require('./util'), ASP = _ref.ASP, katch = _ref.katch, bufeq_secure = _ref.bufeq_secure, unix_time = _ref.unix_time, bufferify = _ref.bufferify;

  _ref1 = require('./keywrapper'), UserId = _ref1.UserId, Lifespan = _ref1.Lifespan, Subkey = _ref1.Subkey, Primary = _ref1.Primary;
  ...
  PgpEngine = (function(_super) {
    ...
    PgpEngine.prototype.fetch = function(key_ids, flags, cb) {
      var err, ff, flag, key, kid, _i, _j, _len, _len1;
      err = key = null;
      key = null;
      ff = 0;
      ...
      err = !key ? new Error("No keys match the given fingerprint") : !this.key(key).fulfills_flags(ff) ? new Error("We don't have a key for the requested PGP ops") : void 0;
      return cb(err, key);
    };
  ...
  KeyManager = (function() {
    ...
    KeyManager.import_from_armored_pgp = function(_arg, cb) {
      var asp, err, msg, raw, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref4, _ref5,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    KeyManager.import_from_pgp_message = function(_arg, cb) {
      var asp, bundle, err, k, kb, msg, packets, userids, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref4,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
