...
(function() {
  var ASP, C, Engine, K, KeyBlock, KeyManager, Lifespan, Message, P3SKB, PgpEngine, Primary, RSA, Subkey, UserId, assert_no_nulls, box, bufeq_secure, bufferify, decode, encode, iced, katch, make_esc, opkts, ops_to_keyflags, parse, read_base64, unbox, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3,
  ...
  _ref = require('./util'), ops_to_keyflags = _ref.ops_to_keyflags, assert_no_nulls = _ref.assert_no_nulls, ASP = _ref.ASP, katch = _ref.katch, bufeq_secure = _ref.bufeq_secure, unix_time = _ref.unix_time, bufferify = _ref.bufferify;
