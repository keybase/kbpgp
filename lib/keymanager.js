...
(function() {
  ...
  KeyManager = (function() {
    ...
    KeyManager.prototype.export_pgp_public_to_client = function(_arg, cb) {
      var asp, msg, regen;
    ...
    KeyManager.prototype._self_sign_primary = function(args, cb) {
    ...
    KeyManager.prototype._sign_subkeys = function(args, cb) {
      return this._apply_to_engines({
        args: args,
