...
(function() {
  var ASP, C, Engine, K, KeyBlock, KeyManager, Lifespan, Message, P3SKB, PgpEngine, Primary, RSA, Subkey, UserIds, box, bufeq_secure, bufferify, decode, encode, iced, katch, make_esc, opkts, parse, read_base64, unbox, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3,
  ...
  PgpEngine = (function(_super) {
    ...
    PgpEngine.prototype._v_allocate_key_packet = function(key) {
      console.log("In v allocate: " + key.flags + " " + key.primary);
      if (key._pgp == null) {
