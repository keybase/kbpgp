...
(function() {
  ...
  KeyManager = (function() {
    ...
    KeyManager.generate = function(_arg, cb) {
      var F, KEY_FLAGS_PRIMARY, KEY_FLAGS_STD, asp, bundle, esc, flags, generated, i, key, lifespan, nbits, nsubs, primary, primary_expire_in, primary_flags, primay_flags, sub_flags, subkey_expire_in, subkeys, userid, userids, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          primary_expire_in = (typeof expire_in !== "undefined" && expire_in !== null ? expire_in.primary : void 0) || K.key_defaults.primary.expire_in;
          subkey_expire_in = (typeof expire_in !== "undefined" && expire_in !== null ? expire_in.subkey : void 0) || K.key_defaults.sub.expire_in;
          lifespan = new Lifespan({
            generated: generated,
            expire_in: primary_expire_in
          });
          primary = new Primary({
            key: key,
            lifespan: lifespan,
