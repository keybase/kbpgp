...
(function() {
  var ASP, C, ECDSA, Encryptor, Engine, K, KeyBlock, KeyFetched, KeyFetcher, KeyManager, Lifespan, Message, P3SKB, PgpEngine, Primary, RSA, Subkey, assert_no_nulls, box, bufeq_secure, bufferify, decode, encode, iced, katch, make_esc, opkts, ops_to_keyflags, parse, read_base64, unbox, unix_time, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3, _ref4,
  ...
  KeyManager = (function(_super) {
    ...
    KeyManager.generate = function(_arg, cb) {
      var F, KEY_FLAGS_PRIMARY, KEY_FLAGS_STD, asp, bundle, ecc, esc, expire_in, flags, gen, generated, i, nbits, nsubs, primary, primary_flags, s, sub_flags, subkey, subkeys, subkeys_out, userid, userids, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _len;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      asp = _arg.asp, userid = _arg.userid, primary = _arg.primary, subkeys = _arg.subkeys, ecc = _arg.ecc, sub_flags = _arg.sub_flags, nsubs = _arg.nsubs, primary_flags = _arg.primary_flags, nbits = _arg.nbits, expire_in = _arg.expire_in;
      asp = ASP.make(asp);
      F = C.key_flags;
    ...
    KeyManager.generate_std = function(_arg, cb) {
      var F, asp, primary, subkeys, userid;
      asp = _arg.asp, userid = _arg.userid;
      F = C.key_flags;
      primary = {
    ...
    KeyManager.import_from_armored_pgp = function(_arg, cb) {
      var asp, err, msg, raw, ret, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref5, _ref6;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    KeyManager.import_from_pgp_message = function(_arg, cb) {
      var asp, bundle, err, k, kb, msg, packets, warnings, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref5;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
    ...
    KeyManager.prototype.is_pgp_same_key = function(k2) {
      return bufeq_secure(this.get_pgp_fingerprint(), k2.get_pgp_fingerprint());
    };
