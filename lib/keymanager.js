...
(function() {
  ...
  KeyManager = (function() {
    ...
    KeyManager.generate = function(_arg, cb) {
      ...
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      asp = _arg.asp, sub_flags = _arg.sub_flags, nsubs = _arg.nsubs, primary_flags = _arg.primary_flags, userid = _arg.userid, nbits = _arg.nbits, expire_in = _arg.expire_in, primary = _arg.primary, subkeys = _arg.subkeys;
      asp = ASP.make(asp);
      F = C.key_flags;
