...
(function() {
  var ASP, C, RSA, UserID, base91, bufferify, encode, encoding, generate_keypair, iced, kbkm, make_esc, make_time_packet, msg, openpgp, openpgpkm, packet, prng, test, triplesec, uint_to_buffer, unix_time, util, __iced_k, __iced_k_noop, _generate_keypair, _ref, _ref1;
  ...
  _generate_keypair = function(_arg, cb) {
    var asp, esc, k, key, nbits, o, passphrase, pp_openpgp, pp_openpgp_buf, rd, ret, timestamp, userid, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
