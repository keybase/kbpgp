...
(function() {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase/kbpgp/src/rsa.iced",
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.validity_check = function(cb) {
      var err;
      err = !this.n.gcd(this.e).equals(BigInteger.ONE) ? new Error("gcd(n,e) != 1") : !this.n.mod(nbv(2)).equals(BigInteger.ONE) ? new Error("n % 2 != 1") : this.e.compareTo(BigInteger.ONE) <= 0 ? new Error("e <= 1") : this.e.compareTo(nbv(0x100000001)) > 0 ? new Error("e > (2^32 + 1)") : null;
      return cb(err);
    };
