        ...
        return (function(__iced_k) {
          if (err == null) {
            (function(__iced_k) {
              ...
              return __iced_k(err == null ? (hd2 = hasher(data), !bufeq_secure(hd1, hd2) ? (console.log("fuuuuuck"), console.log(hd1), console.log(hd2), err = new Error("hash mismatch")) : void 0) : void 0);
            });
          } else {
            return __iced_k();
          }
