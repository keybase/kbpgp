...
(function() {
  ...
  Priv = (function() {
    ...
    Priv.prototype.mod_pow = function(x, d) {
      var dP, dQ, xp, xq;
      dP = this.d.mod(this.p.subtract(BigInteger.ONE));
      dQ = this.d.mod(this.q.subtract(BigInteger.ONE));
      if (this.qInv == null) {
      ...
      /* Chinese remainder theorem (CRT) states:
        ...
        y by r^-1 afterwards.
      */
      xp = x.mod(this.p).modPow(dP, this.p);
      xq = x.mod(this.q).modPow(dQ, this.q);
  ...
  Pub = (function() {
    ...
    Pub.prototype.encrypt = function(p) {
      return this.mod_pow(p, this.e);
    };

    Pub.prototype.verify = function(s) {
      return this.mod_pow(s, this.e);
    };
