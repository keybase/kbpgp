...
(function() {
  var ASP, BigInteger, C, K, MRF, Pair, Priv, Pub, RSA, SHA512, SRF, bn, bufeq_secure, emsa_pkcs1_decode, emsa_pkcs1_encode, iced, make_esc, nbi, nbs, nbv, random_prime, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3, _ref4;
  ...
  Priv = (function() {
    ...
    Priv.prototype.mod_pow_d_crt = function(x, cb) {
      ...
      */
      ...
      y_0 = xp.subtract(xq).multiply(this.qInv).mod(this.p).multiply(this.q).add(xq);
      return cb(y_0);
    };
      ...
      (function(__iced_k) {
        if (err == null) {
          (function(__iced_k) {
            ...
            SRF.random_zn(_this.pub.n, __iced_deferrals.defer({
              assign_fn: (function() {
                return function() {
                  return x0 = arguments[0];
                };
              })(),
              lineno: 259
            }));
            ...
            (function(__iced_k) {
              ...
              (function(__iced_k) {
                ...
                (function(__iced_k) {
                  ...
                  _this.sign(y1, __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
