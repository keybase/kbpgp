...
(function() {
  ...
  Priv = (function() {
    ...
    Priv.alloc = function(raw, pub) {
      var d, err, i, mpis, p, q, u, _i, _ref4;
      err = null;
      mpis = [];
      ...
      if (err) {
        ...
        p = mpis[0], d = mpis[1], q = mpis[2], u = mpis[3];
        return [
          null, new Priv({
            p: p,
            d: d,
  ...
  Pair = (function() {
    ...
    Pair.prototype.sanity_check = function() {
      ...
      if (this.priv.d.multiply(this.pub.e).mod(this.priv.phi()).compareTo(BigInteger.ONE) !== 0) {
    ...
    Pair.prototype.verify_unpad_and_check_hash = function(sig, data, hash) {
      var b, err, hd1, hd2, v, _ref4, _ref5;
      _ref4 = bn.mpi_from_buffer(sig), err = _ref4[0], sig = _ref4[1];
      if (err == null) {
        v = this.verify(sig);
        b = new Buffer(v.toByteArray());
        _ref5 = emsa_pkcs1_decode(b, hash), err = _ref5[0], hd1 = _ref5[1];
        if (err == null) {
          hd2 = hash(data);
