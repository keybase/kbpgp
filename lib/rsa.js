...
(function() {
  var ASP, BigInteger, C, Pair, Priv, Pub, RSA, SHA512, bn, emsa_pkcs1_encode, iced, make_esc, nbi, nbs, nbv, random_prime, __iced_k, __iced_k_noop, _ref, _ref1;
  ...
  emsa_pkcs1_encode = require('./encode/pad').emsa_pkcs1_encode;
  ...
  Pair = (function() {
    ...
    function Pair(_arg) {
      ...
      this.priv.parent = this.pub.parent = this;
    }
    ...
    Pair.prototype.pad_and_sign = function(data, _arg) {
      ...
      hash = _arg.hash;
      hash || (hash = SHA512);
      m = emsa_pkcs1_encode(data, this.pub.n.mpi_byte_length(), {
        hash: hash
      });
