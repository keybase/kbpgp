...
(function() {
  var K, KeyMaterial, Packet, SHA512, bencode, bufferify, iced, make_esc, native_rng, pack, rsa, sign, triplesec, verify, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  KeyMaterial = (function(_super) {
    ...
    function KeyMaterial(_arg) {
      this.key = _arg.key, this.timestamp = _arg.timestamp, this.expires = _arg.expires, this.userid = _arg.userid, this.passphrase = _arg.passphrase, this.sig = _arg.sig, this.rawkey = _arg.rawkey, this.primary = _arg.primary;
    ...
    KeyMaterial.prototype._self_sign_key = function(_arg, cb) {
      var body, err, hasher, progress_hook, res, type, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      hasher = _arg.hasher, progress_hook = _arg.progress_hook;
      if (hasher == null) {
        hasher = SHA512;
      }
