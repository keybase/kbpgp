...
(function() {
  ...
  KeyMaterial = (function(_super) {
    ...
    function KeyMaterial(_arg) {
      this.key = _arg.key, this.timestamp = _arg.timestamp, this.userid = _arg.userid, this.passphrase = _arg.passphrase, this.sig = _arg.sig, this.rawkey = _arg.rawkey, this.primary = _arg.primary;
