...
(function() {
  var BaseKey, BaseKeyPair, K, NaclDh, Pair, Priv, Pub, SRF, TYPE, b2u, bufeq_fast, bufeq_secure, genseed, iced, kbnacl, konst, u2b, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  Pub = (function() {
    ...
    Pub.prototype.verify = function(_arg, cb) {
      var detached, err, naclw, payload, sig, _ref2;
  ...
  Pair = (function(_super) {
    ...
    Pair.generate = function(_arg, cb) {
      var arg, err, naclw, priv, pub, publicKey, secretKey, seed, server_half, split, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ...
      (function(_this) {
        ...
        return function() {
          ...
          if (typeof err === "undefined" || err === null) {
            naclw = kbnacl.alloc({});
            _ref2 = naclw.genFromSeed({
              seed: seed
            }), secretKey = _ref2.secretKey, publicKey = _ref2.publicKey;
