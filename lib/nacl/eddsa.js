...
(function() {
  var BaseKey, BaseKeyPair, K, NaclDh, Pair, Priv, Pub, SRF, TYPE, b2u, bufeq_fast, bufeq_secure, iced, konst, sign, u2b, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  Pub = (function() {
    ...
    Pub.alloc = function(kid) {
      var err, key;
      err = key = null;
      err = kid.length !== Pub.LEN ? new Error("bad key length") : !bufeq_fast(kid.slice(-1), Pub.TRAILER) ? new Error("bad trailing byte") : !bufeq_fast(kid.slice(0, 2), Pub.HEADER) ? new Error("bad header") : (key = new Pub(kid[{
        2: -1
      }]), null);
      return [err, key];
    };
    ...
    Pub.prototype.verify = function(_arg, cb) {
      var detached, err, ok, payload, r_payload, sig;
  ...
  Pair = (function(_super) {
    ...
    Pair.type = K.public_key_algorithms.EDDSA;
    ...
    Pair.prototype.sign = function(_arg, cb) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          if (_this.priv != null) {
            ...
            return __iced_k(err = new Error("new secret key available"));
          }
        });
      })(this)((function(_this) {
        return function() {
    ...
    Pair.prototype.verify = function(_arg, cb) {
    ...
    Pair.generate = function(params, cb) {
      var priv, pub, publicKey, secretKey, seed, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
          ...
          SRF().random_bytes(sign.seedLength, __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
