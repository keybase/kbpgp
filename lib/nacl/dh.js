        ...
        return (function(__iced_k) {
          if (seed == null) {
            (function(__iced_k) {
              ...
              SRF().random_bytes(box.secretKeyLength, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
            ...
            return __iced_k(seed.length !== box.secretKeyLength ? err = new Error("Wrong seed length; need " + box.secretKeyLength + " bytes; got " + seed.length) : void 0);
          }
        });
      })(this)((function(_this) {
        return function() {
