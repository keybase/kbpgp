...
(function() {
  var BaseKey, BaseKeyPair, K, NaclEddsa, Pair, Priv, Pub, SRF, TYPE, b2u, box, bufeq_fast, iced, konst, u2b, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  Pub = (function() {
    ...
    Pub.prototype.encrypt = function(_arg, cb) {
      ...
      (function(_this) {
        ...
        return function() {
          res = box(b2u(plaintext), b2u(nonce), b2u(_this.key), b2u(sender.pub.key));
          return cb(null, {
            ciphertext: u2b(res),
            nonce: nonce
          });
  ...
  Pair = (function(_super) {
    ...
    Pair.generate = function(_arg, cb) {
      var err, priv, pub, publicKey, secretKey, seed, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      seed = _arg.seed;
      err = null;
        ...
        return (function(__iced_k) {
          if (seed == null) {
            (function(__iced_k) {
              ...
              SRF().random_bytes(box.seedLength, __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
            ...
            return __iced_k(seed.length !== box.seedLength ? err = new Error("Wrong seed length; need " + box.seedLength + " bytes; got " + seed.length) : void 0);
          }
        });
      })(this)((function(_this) {
        return function() {
          var _ref2;
          if (err == null) {
            _ref2 = box.keyPair.fromSeed(b2u(seed)), secretKey = _ref2.secretKey, publicKey = _ref2.publicKey;
