...
(function() {
  var ASP, BaseKey, BaseKeyPair, C, K, MRF, Pair, Priv, Pub, SRF, bn, bufeq_secure, iced, konst, make_esc, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  Priv = (function() {
    ...
    Priv.prototype.sign = function(h, cb) {
      var err, g, hi, k, p, q, r, s, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
      _ref3 = this.pub, p = _ref3.p, q = _ref3.q, g = _ref3.g;
    ...
    Priv.alloc = function(raw, pub) {
      var err, orig, x, _ref3;
      orig = raw.length;
      _ref3 = bn.mpi_from_buffer(raw), err = _ref3[0], x = _ref3[1], raw = _ref3[2];
      if (err != null) {
        return [err, null];
      } else {
        return [
  ...
  Pair = (function(_super) {
    ...
    Pair.prototype.verify_unpad_and_check_hash = function(sig, data, hasher, cb) {
      var err, hash, v, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      err = null;
    ...
    Pair.parse_sig = function(slice) {
      ...
      _ref3 = this.read_sig_from_buf(buf), err = _ref3[0], ret = _ref3[1], n = _ref3[2];
      if (err != null) {
        throw err;
      }
      slice.advance(n);
