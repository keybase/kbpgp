...
(function() {
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.verify = function(_arg, h, cb) {
      ...
      r = _arg[0], s = _arg[1];
      err = null;
      if ((r.signum() <= 0) || (r.compareTo(this.q) >= 0)) {
        err = new Error("bad r");
      } else if ((s.signum() <= 0) || (s.compareTo(this.q) >= 0)) {
        err = new Error("bad s");
      } else {
        err = null;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/michal/SourceCode/keybase/go/src/github.com/keybase/kbpgp/src/dsa.iced",
            funcname: "Priv.sign"
          });
