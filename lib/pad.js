...
(function() {
  var C, SHA512, SRF, bufeq_secure, buffer_to_ui8a, ct, eme_random, emsa_pkcs1_decode, emsa_pkcs1_encode, hash_headers, iced, nbs, __iced_k, __iced_k_noop, _ref;
          ...
          if (!(bytes.length < n)) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/michal/SourceCode/keybase/go/src/github.com/keybase/kbpgp/src/pad.iced"
              });
  ...
  exports.eme_pkcs1_decode = function(v) {
    var eq0, err, header_hi, header_lo, i, index, looking_for_index, ret, valid, valid_ps, _i, _ref1;
    err = ret = null;
    valid = false;
    if (v.length < 12) {
    ...
    looking_for_index = 1;
    for (i = _i = 2, _ref1 = v.length; 2 <= _ref1 ? _i < _ref1 : _i > _ref1; i = 2 <= _ref1 ? ++_i : --_i) {
