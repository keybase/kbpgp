...
(function() {
  var ASP, C, RSA, encoding, generate_keypair, generate_raw_keypair, iced, make_esc, make_time_packet, msg, openpgp, packet, test, triplesec, uint_to_buffer, util, __iced_k, __iced_k_noop, _generate_keypair, _ref, _ref1;
  ...
  generate_raw_keypair = function(_arg, cb) {
    var asp, esc, key, nbits, okey, priv, pub, ret, timePacket, type, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
