...
(function() {
  var C, DH, EdDSA, EncKeyManager, Encryption, K, KeyManager, KeyManagerInterface, Signature, SignatureEngine, akatch, alloc, asyncify, athrow, base64u, box, buffer_xor, bufferify, decode_sig, encode, get_sig_body, iced, konst, make_esc, unbox, __iced_k, __iced_k_noop, _ref,
  ...
  _ref = require('../util'), athrow = _ref.athrow, bufferify = _ref.bufferify, base64u = _ref.base64u, buffer_xor = _ref.buffer_xor, asyncify = _ref.asyncify, akatch = _ref.akatch;
  ...
  KeyManager = (function(_super) {
    ...
    KeyManager.import_private = function(_arg, cb) {
      ...
      return KeyManager._import_private({
        klass: KeyManager,
        hex: hex,
        raw: raw
      }, cb);
    ...
    KeyManager._import_private = function(_arg, cb) {
      var err, hex, klass, km, raw, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      klass = _arg.klass, hex = _arg.hex, raw = _arg.raw;
      err = ret = null;
      if (hex != null) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase/kbpgp/src/keybase/hilev.iced",
            funcname: "KeyManager._import_private"
          });
          KeyManager.generate({
            klass: klass,
            seed: raw
  ...
  get_sig_body = function(_arg) {
    var armored, decoded, err, _ref1;
    armored = _arg.armored;
    _ref1 = decode_sig({
      armored: armored
    }), err = _ref1[0], decoded = _ref1[1];
  ...
  SignatureEngine = (function() {
    ...
    SignatureEngine.prototype.get_body = function(args, cb) {
      var err, res, _ref1;
      _ref1 = get_sig_body(args, cb), err = _ref1[0], res = _ref1[1];
      return cb(err, res);
    };
