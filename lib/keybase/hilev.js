...
(function() {
  var C, DH, EdDSA, EncKeyManager, Encryption, K, KeyManager, KeyManagerInterface, Signature, SignatureEngine, akatch, alloc, asyncify, box, buffer_xor, encode, iced, konst, make_esc, unbox, __iced_k, __iced_k_noop, _ref,
  ...
  _ref = require('../util'), buffer_xor = _ref.buffer_xor, asyncify = _ref.asyncify, akatch = _ref.akatch;
  ...
  exports.unbox = unbox = function(_arg, cb) {
    var armored, buf, encrypt_for, esc, packet, rawobj, res, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    armored = _arg.armored, rawobj = _arg.rawobj, encrypt_for = _arg.encrypt_for;
