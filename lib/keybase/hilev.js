...
(function() {
  var C, DH, EdDSA, EncKeyManager, Encryption, K, KeyManager, KeyManagerInterface, Signature, SignatureEngine, akatch, alloc, asyncify, athrow, base64u, box, buffer_xor, bufferify, encode, iced, konst, make_esc, unbox, __iced_k, __iced_k_noop, _ref,
  ...
  SignatureEngine = (function() {
    ...
    SignatureEngine.prototype.get_body = function(_arg, cb) {
      var armored, res;
