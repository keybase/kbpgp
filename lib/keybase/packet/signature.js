...
(function() {
  var C, K, KeyManager, Packet, Signature, iced, konst, make_esc, __iced_k, __iced_k_noop,
  ...
  Signature = (function(_super) {
    ...
    Signature.alloc = function(_arg) {
      ...
      ret = null;
      err = tag !== Signature.tag() ? new Error("wrong tag found: " + tag) : (a = body.hash_type) !== (b = Signature.HASH_TYPE) ? new Error("Expeched SHA512 (type " + b + "); got " + a) : (a = packet.sig_type) !== (b = Signature.SIG_TYPE) ? err = new Error("Expected EDDSA (type " + b + "); got " + a) : (ret = new Signature(body), null);
      if (err != null) {
        throw err;
      }
      return ret;
    ...
    Signature.prototype.verify = function(cb) {
      var err, km, pair, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      ...
      (function(_this) {
        return (function(__iced_k) {
          var _ref;
          if (((_ref = nacl.Pair.parse(packet.body.key), err = _ref[0], pair = _ref[1], _ref) != null) && (err == null)) {
            (function(__iced_k) {
              ...
              pair.verify(_this, esc(__iced_deferrals.defer({
                lineno: 56
              })));
              __iced_deferrals._fulfill();
            })(function() {
              return __iced_k(km = new KeyManager({
                key: pair
              }));
            });
          } else {
    ...
    Signature.prototype.unbox = function(cb) {
    ...
    Signature.sign = function(_arg, cb) {
