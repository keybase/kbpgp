...
(function() {
  var Base, K, Packet, SelfSignKeybaseUsername, SelfSignPgpUserid, SubkeySignature, iced, sign, verfiy, __iced_k, __iced_k_noop, _ref,
  ...
  Base = (function(_super) {
    ...
    Base.prototype.sign = function(_arg, cb) {
      var asp, body, err, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
  ...
  SelfSignPgpUserid = (function(_super) {
    ...
    function SelfSignPgpUserid(_arg) {
      ...
      SelfSignPgpUserid.__super__.constructor.call(this, {
        type: K.sig_types.self_sign_pgp_username,
  ...
  SubkeySignature = (function(_super) {
    ...
    function SubkeySignature(_arg, cb) {
