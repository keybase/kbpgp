...
(function() {
  ...
  KeyMaterial = (function(_super) {
    ...
    function KeyMaterial(_arg) {
      this.key = _arg.key, this.timestamp = _arg.timestamp, this.expires = _arg.expires, this.userid = _arg.userid, this.passphrase = _arg.passphrase, this.sig = _arg.sig, this.rawkey = _arg.rawkey;
    ...
    KeyMaterial.prototype._encode_keys = function(_arg, sig, cb) {
      var err, packet, priv, private_key, progress_hook, pub, public_key, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      progress_hook = _arg.progress_hook;
