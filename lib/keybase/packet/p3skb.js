        ...
        return (function(__iced_k) {
          switch (_this.priv.encryption) {
            ...
            case K.key_encryption.triplesec_v1:
              (function(__iced_k) {
                if (((a = passphrase_generation) != null) && ((b = _this.priv.passphrase_generation) != null) && (a !== b)) {
                  return __iced_k(err = new Error("Bad passphrase generation (wanted " + a + " but got " + b + ")"));
                } else {
                  dec = new Decryptor({
                    enc: tsenc
                  });
                  ...
                  (function(__iced_k) {
                    ...
                    dec.scrub();
                    return __iced_k(err == null ? (_this.priv.data = raw, _this.priv.encryption = K.key_encryption.none) : void 0);
                  });
                }
              })(__iced_k);
              break;
