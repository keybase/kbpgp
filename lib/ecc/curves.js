...
(function() {
  var BigInteger, Curve, H, OIDS, OID_LOOKUP, base, k, nist_p256, nist_p384, nist_p521, v,
  ...
  exports.Curve = Curve = (function(_super) {
    ...
    Curve.prototype.point_to_mpi_buffer = function(p) {
      return Buffer.concat([new Buffer([0x4]), p.x.toBuffer(this.p.byteLength()), p.y.toBuffer(this.p.byteLength())]);
    };
