...
(function() {
  var BigInteger, Curve, H, OIDS, OID_LOOKUP, SlicerBuffer, base, k, nist_p256, nist_p384, nist_p521, uint_to_buffer, v,
  ...
  exports.Curve = Curve = (function(_super) {
    ...
    Curve.prototype.point_to_mpi_buffer = function(p) {
      return Buffer.concat([uint_to_buffer(16, this.mpi_bit_size()), new Buffer([0x4]), p.affineX.toBuffer(this.p.byteLength()), p.affineY.toBuffer(this.p.byteLength())]);
    };
