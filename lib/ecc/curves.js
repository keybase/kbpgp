...
(function() {
  var BigInteger, Curve, H, Point, getCurveByName, _ref;

  BigInteger = require('bn').BigInteger;

  _ref = require('keybase-ecurve'), Curve = _ref.Curve, Point = _ref.Point, getCurveByName = _ref.getCurveByName;

  exports.H = H = function(x) {
    return BigInteger.fromHex(x.split(/\s+/).join(''));
  };

  exports.nist_p256 = function() {
    return getCurveByName('secp256r1');
  };

  exports.nist_p384 = function() {
    var Gx, Gy, a, b, h, n, p;
