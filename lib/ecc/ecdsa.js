...
(function() {
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.verify = function(_arg, h, cb) {
      ...
      if ((r.signum() <= 0) || (r.compareTo(this.curve.n) >= 0)) {
        err = new Error("bad r");
      } else if ((s.signum() <= 0) || (s.compareTo(this.curve.n) >= 0)) {
        err = new Error("bad s");
      } else {
        n = this.curve.n;
        w = s.modInverse(n);
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/michal/SourceCode/keybase/go/src/github.com/keybase/kbpgp/src/ecc/ecdsa.iced",
            funcname: "Priv.sign"
          });
