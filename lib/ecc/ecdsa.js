...
(function() {
  var ASP, BaseEccKey, BaseKeyPair, BigInteger, C, K, MRF, Pair, Pub, SRF, bn, bufeq_secure, iced, konst, make_esc, nbits, nbv, uint_to_buffer, __iced_k, __iced_k_noop, _ref, _ref1,
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.verify = function(_arg, h, cb) {
      var d, err, hi, k, n, p, r, s, u1, u2, v, w;
      r = _arg[0], s = _arg[1];
      err = null;
      console.log(h);
