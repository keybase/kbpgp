...
(function() {
  var ASP, BaseEccKey, BaseKey, BaseKeyPair, BigInteger, C, ECDH, K, MRF, Pair, Priv, Pub, SRF, alloc_by_nbits, bn, bufeq_secure, iced, konst, make_esc, nbits, nbv, uint_to_buffer, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  _ref1 = require('../util'), uint_to_buffer = _ref1.uint_to_buffer, bufeq_secure = _ref1.bufeq_secure, ASP = _ref1.ASP;
  ...
  _ref2 = require('../basekeypair'), BaseKeyPair = _ref2.BaseKeyPair, BaseKey = _ref2.BaseKey;

  BaseEccKey = require('./base').BaseEccKey;

  ECDH = require('./ecdh').ECDH;

  alloc_by_nbits = require('./curves').alloc_by_nbits;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/max/src/keybase/kbpgp/src/ecc/ecdsa.iced",
            funcname: "Priv.sign"
          });
  ...
  Pair = (function(_super) {
    ...
    Pair.generate = function(_arg, cb) {
      var asp, curve, err, nbits, _ref3;
      nbits = _arg.nbits, asp = _arg.asp;
      nbits || (nbits = 256);
      return _ref3 = alloc_by_nbits(nbits), err = _ref3[0], curve = _ref3[1], _ref3;
    };
