...
(function() {
  var BaseKey, BaseKeyPair, C, Pair, Priv, Pub, konst, nacl, util, _ref,
  ...
  Pub = (function(_super) {
    ...
    Pub._alloc = function(raw) {
      ...
      return cb(new Error("not done yet!"));
    };
    ...
    Pub.alloc = function(raw) {
      ...
      pub = len = err = null;
      try {
        _ref1 = Priv.alloc(raw), pub = _ref1[0], len = _ref1[1];
      } catch (_error) {
        e = _error;
        err = e;
      }
