...
(function() {
  var BaseKey, BaseKeyPair, C, Pair, Priv, Pub, SlicerBuffer, iced, kbnacl, konst, uint_to_buffer, util, __iced_k, __iced_k_noop, _ref,
  ...
  Priv = (function(_super) {
    ...
    Priv._alloc = function(raw, pub) {
      var key_len, len, m, n, pre, priv, publicKey, sb, secretKey, x, _ref1;
      sb = new SlicerBuffer(raw);
      pre = sb.rem();
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/home/zapu/pgp/kbpgp/src/ecc/eddsa.iced",
