...
(function() {
  ...
  Priv = (function(_super) {
    ...
    Priv.prototype.format_params = function() {
      return Buffer.concat([uint_to_buffer(8, this.pub.curve.oid.length), this.pub.curve.oid, uint_to_buffer(8, this.pub.type), this.pub.serialize_params(), new Buffer("Anonymous Sender    ", "utf8")]);
    };

    Priv.prototype.decrypt = function(c, cb) {
      var S, S_compact, V, curve, err, esc, params, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
