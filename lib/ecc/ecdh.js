...
(function() {
  var ASP, BaseEccKey, BaseKey, BaseKeyPair, Const, Output, Pair, Priv, Pub, SRF, SlicerBuffer, bn, bufeq_secure, ecc_pkcs5_pad_data, hashmod, iced, konst, make_esc, sym, uint_to_buffer, unwrap, wrap, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  _ref2 = require('../rfc3394'), wrap = _ref2.wrap, unwrap = _ref2.unwrap;
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.format_params = function(_arg) {
      var fingerprint, list;
      fingerprint = _arg.fingerprint;
      list = [uint_to_buffer(8, this.curve.oid.length), this.curve.oid, uint_to_buffer(8, this.type), this.serialize_params(), new Buffer("Anonymous Sender    ", "utf8"), fingerprint];
      console.log(list);
    ...
    Pub.prototype.encrypt = function(m, _arg, cb) {
      var C, G, S, V, fingerprint, key, n, params, v, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      fingerprint = _arg.fingerprint;
      _ref3 = this.curve, n = _ref3.n, G = _ref3.G;
      (function(_this) {
        return (function(__iced_k) {
          ...
          SRF().random_zn(n.subtract(bn.nbv(2)), __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
  ...
  Pair = (function(_super) {
    ...
    Pair.prototype.pad_and_encrypt = function(data, _arg, cb) {
      var C, V, err, fingerprint, m, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      fingerprint = _arg.fingerprint;
      err = ret = null;
