...
(function() {
  var ASP, BaseEccKey, BaseKey, BaseKeyPair, C, K, MRF, Output, Pair, Priv, Pub, SRF, bn, bufeq_secure, eme_pkcs1_decode, eme_pkcs1_encode, hashmod, iced, konst, make_esc, sym, uint_to_buffer, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3,
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.serialize = function() {
      ...
      console.log("base -->");
      console.log([base, uint_to_buffer(8, 3), uint_to_buffer(8, 1), uint_to_buffer(8, this.hasher.type), uint_to_buffer(8, this.cipher.type)]);
      ret = Buffer.concat([base, uint_to_buffer(8, 3), uint_to_buffer(8, 1), uint_to_buffer(8, this.hasher.type), uint_to_buffer(8, this.cipher.type)]);
