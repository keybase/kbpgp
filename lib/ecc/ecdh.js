...
(function() {
  var ASP, BaseEccKey, BaseKey, BaseKeyPair, C, MRF, Output, Pair, Priv, Pub, SRF, SlicerBuffer, bn, bufeq_secure, ecc_pkcs5_pad_data, hashmod, iced, konst, make_esc, sym, uint_to_buffer, unwrap, xxd, __iced_k, __iced_k_noop, _ref, _ref1, _ref2,
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.encrypt = function(m, _arg, cb) {
      var c, fingerprint, k, ___iced_passed_deferral, __iced_deferrals, __iced_k;
  ...
  Pair = (function(_super) {
    ...
    Pair.prototype.pad_and_encrypt = function(data, _arg, cb) {
      var c, err, fingerprint, m, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref3;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      fingerprint = _arg.fingerprint;
      err = ret = null;
      _ref3 = ecc_pkcs5_pad_data(data), err = _ref3[0], m = _ref3[1];
      (function(_this) {
        return (function(__iced_k) {
          if (err == null) {
            (function(__iced_k) {
              ...
              return __iced_k(ret = _this.export_output(c));
            });
          } else {
            return __iced_k();
          }
  ...
  Output = (function() {
    ...
    Output.prototype.load_V = function(curve, cb) {
      var err, _ref3;
      _ref3 = curve.mpi_point_from_buffer(this.V_buf), err = _ref3[0], this.V = _ref3[1];
