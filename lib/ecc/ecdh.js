...
(function() {
  var ASP, BaseEccKey, BaseKey, BaseKeyPair, C, MRF, Output, Pair, Priv, Pub, SRF, SlicerBuffer, bn, bufeq_secure, eme_pkcs1_decode, eme_pkcs1_encode, hashmod, iced, konst, make_esc, sym, uint_to_buffer, unwrap, xxd, __iced_k, __iced_k_noop, _ref, _ref1, _ref2, _ref3,
  ...
  Pub = (function(_super) {
    ...
    Pub.prototype.read_params = function(sb) {
      ...
      if ((val = sb.read_uint8()) !== (v = C.ecdh.version)) {
    ...
    Pub.prototype.serialize_params = function() {
      return Buffer.concat([uint_to_buffer(8, C.ecdh.param_bytes), uint_to_buffer(8, C.ecdh.version), uint_to_buffer(8, this.hasher.type), uint_to_buffer(8, this.cipher.type)]);
    };
  ...
  Priv = (function(_super) {
    ...
    Priv.prototype.format_params = function(_arg) {
      var fingerprint;
      fingerprint = _arg.fingerprint;
      return Buffer.concat([uint_to_buffer(8, this.pub.curve.oid.length), this.pub.curve.oid, uint_to_buffer(8, this.pub.type), this.pub.serialize_params(), new Buffer("Anonymous Sender    ", "utf8"), fingerprint]);
    };

    Priv.prototype.kdf = function(_arg) {
      var X, X_compact, buf, hash, o_bytes, params;
      X = _arg.X, params = _arg.params;
      o_bytes = this.pub.cipher.key_size;
      X_compact = this.pub.curve.point_to_mpi_buffer_compact(X);
      buf = Buffer.concat([new Buffer([0, 0, 0, 1]), X_compact, params]);
      hash = this.pub.hasher(buf);
      return hash.slice(0, o_bytes);
    };

    Priv.prototype.decrypt = function(c, _arg, cb) {
      var S, V, curve, err, esc, fingerprint, key, params, sesskey, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      fingerprint = _arg.fingerprint;
      ...
      (function(_this) {
        ...
        return function() {
          ...
          }), err = _ref4[0], sesskey = _ref4[1];
          return cb(err, sesskey);
        };
      })(this));
    };
  ...
  Pair = (function(_super) {
    ...
    Pair.prototype.decrypt_and_unpad = function(ciphertext, _arg, cb) {
      var b, err, fingerprint, m, ret, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      fingerprint = _arg.fingerprint;
      err = ret = null;
