...
(function() {
  ...
  exports.alloc = alloc = function(typ, streaming) {
    var klass, name, ret;
    ret = null;
    name = _lookup[typ];
    if (name != null) {
    ...
    ret = klass == null ? null : streaming ? make_streamer(klass, name, typ)() : make_hasher(klass, name, typ);
    return ret;
  };

  exports.alloc_or_throw = alloc_or_throw = function(typ, streaming) {
    var ret;
