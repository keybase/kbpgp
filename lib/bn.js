...
(function() {
  var BigInteger, bi_from_left_n_bits, buffer_shift_right, buffer_to_ui8a, mpi_byte_length, mpi_from_buffer, mpi_to_padded_octets, nbi, nbits, nbs, nbv, toMPI, _ref;
  ...
  bi_from_left_n_bits = function(raw, bits) {
    var buf, bytes, rem;
    rem = bits % 8;
